...
9!==b?", ":"";return a+"]"},transpose:function(){var a=this.data,b;b=a[1];a[1]=a[3];a[3]=b;b=a[2];a[2]=a[6];a[6]=b;b=a[5];a[5]=a[7];a[7]=b;return this}};Object.defineProperty(e,"IDENTITY",{get:function(){var a=new e;return function(){return a}}()});Object.defineProperty(e,"ZERO",{get:function(){var a=new e(0,0,0,0,0,0,0,0,0);return function(){return a}}()});return{Mat3:e}}());pc.extend(pc,function(){var e=function(a,b,c,d,f,g,h,k,m,e,l,r,p,q,t,x){a&&16===a.length?this.data=new Float32Array(a):(this.data=new Float32Array(16),"number"===typeof a?(this.data[0]=a,this.data[1]=b,this.data[2]=c,this.data[3]=d,this.data[4]=f,this.data[5]=g,this.data[6]=h,this.data[7]=k,this.data[8]=m,this.data[9]=e,this.data[10]=l,this.data[11]=r,this.data[12]=p,this.data[13]=q,this.data[14]=t,this.data[15]=x):this.setIdentity())};e.prototype={add2:function(a,b){var c=a.data,d=b.data,f=this.data;
...
1===a[10]&&0===a[11]&&0===a[12]&&0===a[13]&&0===a[14]&&1===a[15]},mul2:function(a,b){var c,d,f,g,h,k,m,e,l,r,p,q,t,x,y,w,u,v,B,A;w=a.data;var C=b.data,z=this.data;c=w[0];d=w[1];f=w[2];g=w[3];h=w[4];k=w[5];m=w[6];e=w[7];l=w[8];r=w[9];p=w[10];q=w[11];t=w[12];x=w[13];y=w[14];w=w[15];u=C[0];v=C[1];B=C[2];A=C[3];z[0]=c*u+h*v+l*B+t*A;z[1]=d*u+k*v+r*B+x*A;z[2]=f*u+m*v+p*B+y*A;z[3]=g*u+e*v+q*B+w*A;u=C[4];v=C[5];B=C[6];A=C[7];z[4]=c*u+h*v+l*B+t*A;z[5]=d*u+k*v+r*B+x*A;z[6]=f*u+m*v+p*B+y*A;z[7]=g*u+e*v+q*B+
w*A;u=C[8];v=C[9];B=C[10];A=C[11];z[8]=c*u+h*v+l*B+t*A;z[9]=d*u+k*v+r*B+x*A;z[10]=f*u+m*v+p*B+y*A;z[11]=g*u+e*v+q*B+w*A;u=C[12];v=C[13];B=C[14];A=C[15];z[12]=c*u+h*v+l*B+t*A;z[13]=d*u+k*v+r*B+x*A;z[14]=f*u+m*v+p*B+y*A;z[15]=g*u+e*v+q*B+w*A;return this},mul:function(a){return this.mul2(this,a)},transformPoint:function(a,b){var c=this.data,d=a.data;b=void 0===b?new pc.Vec3:b;return b.set(d[0]*c[0]+d[1]*c[4]+d[2]*c[8]+c[12],d[0]*c[1]+d[1]*c[5]+d[2]*c[9]+c[13],d[0]*c[2]+d[1]*c[6]+d[2]*c[10]+c[14])},transformVector:function(a,
...
c;d[11]=0;d[12]=0;d[13]=0;d[14]=0;d[15]=1;return this},invert:function(){var a,b,c,d,f,g,h,k,m,e,l,r,p,q,t,x,y,w,u,v,B,A,C,z,F,I,G,H,D,E;E=this.data;a=E[0];b=E[1];c=E[2];d=E[3];f=E[4];g=E[5];h=E[6];k=E[7];m=E[8];e=E[9];l=E[10];r=E[11];p=E[12];q=E[13];t=E[14];x=E[15];y=a*g-b*f;w=a*h-c*f;u=a*k-d*f;v=b*h-c*g;B=b*k-d*g;A=c*k-d*h;C=m*q-e*p;z=m*t-l*p;F=m*x-r*p;I=e*t-l*q;G=e*x-r*q;H=l*x-r*t;D=y*H-w*G+u*I+v*F-B*z+A*C;0===D?this.setIdentity():(D=1/D,E[0]=(g*H-h*G+k*I)*D,E[1]=(-b*H+c*G-d*I)*D,E[2]=(q*A-t*B+
x*v)*D,E[3]=(-e*A+l*B-r*v)*D,E[4]=(-f*H+h*F-k*z)*D,E[5]=(a*H-c*F+d*z)*D,E[6]=(-p*A+t*u-x*w)*D,E[7]=(m*A-l*u+r*w)*D,E[8]=(f*G-g*F+k*C)*D,E[9]=(-a*G+b*F-d*C)*D,E[10]=(p*B-q*u+x*y)*D,E[11]=(-m*B+e*u-r*y)*D,E[12]=(-f*I+g*z-h*C)*D,E[13]=(a*I-b*z+c*C)*D,E[14]=(-p*v+q*w-t*y)*D,E[15]=(m*v-e*w+l*y)*D);return this},set:function(a){var b=this.data;b[0]=a[0];b[1]=a[1];b[2]=a[2];b[3]=a[3];b[4]=a[4];b[5]=a[5];b[6]=a[6];b[7]=a[7];b[8]=a[8];b[9]=a[9];b[10]=a[10];b[11]=a[11];b[12]=a[12];b[13]=a[13];b[14]=a[14];b[15]=
a[15];return this},setIdentity:function(){var a=this.data;a[0]=1;a[1]=0;a[2]=0;a[3]=0;a[4]=0;a[5]=1;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=1;a[11]=0;a[12]=0;a[13]=0;a[14]=0;a[15]=1;return this},setTRS:function(a,b,c){var d,f,g,h,k,m,e,l,r,p,q,t,x;d=a.x;f=a.y;a=a.z;g=b.x;h=b.y;k=b.z;m=b.w;b=c.x;e=c.y;c=c.z;l=g+g;r=h+h;p=k+k;q=g*l;t=g*r;g*=p;x=h*r;h*=p;k*=p;l*=m;r*=m;m*=p;p=this.data;p[0]=(1-(x+k))*b;p[1]=(t+m)*b;p[2]=(g-r)*b;p[3]=0;p[4]=(t-m)*e;p[5]=(1-(q+k))*e;p[6]=(h+l)*e;p[7]=0;p[8]=(g+r)*c;p[9]=(h-
l)*c;p[10]=(1-(q+x))*c;p[11]=0;p[12]=d;p[13]=f;p[14]=a;p[15]=1;return this},transpose:function(){var a,b=this.data;a=b[1];b[1]=b[4];b[4]=a;a=b[2];b[2]=b[8];b[8]=a;a=b[3];b[3]=b[12];b[12]=a;a=b[6];b[6]=b[9];b[9]=a;a=b[7];b[7]=b[13];b[13]=a;a=b[11];b[11]=b[14];b[14]=a;return this},invertTo3x3:function(a){var b,c,d,f;b=this.data;a=a.data;var g=b[0],h=b[1],k=b[2],m=b[4],e=b[5],l=b[6],r=b[8],p=b[9],q=b[10];b=q*e-l*p;c=-q*m+l*r;d=p*m-e*r;f=g*b+h*c+k*d;if(0===f)return this;f=1/f;a[0]=f*b;a[1]=f*(-q*h+k*
p);a[2]=f*(l*h-k*e);a[3]=f*c;a[4]=f*(q*g-k*r);a[5]=f*(-l*g+k*m);a[6]=f*d;a[7]=f*(-p*g+h*r);a[8]=f*(e*g-h*m);return this},getTranslation:function(a){a=void 0===a?new pc.Vec3:a;return a.set(this.data[12],this.data[13],this.data[14])},getX:function(a){a=void 0===a?new pc.Vec3:a;return a.set(this.data[0],this.data[1],this.data[2])},getY:function(a){a=void 0===a?new pc.Vec3:a;return a.set(this.data[4],this.data[5],this.data[6])},getZ:function(a){a=void 0===a?new pc.Vec3:a;return a.set(this.data[8],this.data[9],
...
1][1];var f=0,g=d.length?d[0][1]:0,h=1,k=0;b=0;for(c=d.length;b<c;b++){if(d[b][0]===a)return d[b][1];k=d[b][1];if(a<d[b][0]){h=d[b][0];break}f=d[b][0];g=d[b][1]}c=h-f;a=0===c?0:(a-f)/c;if(1===this.type)a*=a*(3-2*a);else if(2===this.type||3===this.type){c=g+(g-k);var m=k+(k-g),e=h=f=h-f;0<b&&--b;0<b&&(c=d[b-1][1],h=d[b][0]-d[b-1][0]);d.length>b+1&&(f=d[b+1][0]-d[b][0]);d.length>b+2&&(e=d[b+2][0]-d[b+1][0],m=d[b+2][1]);c=g+(c-g)*f/h;m=k+(m-k)*f/e;return 2===this.type?this._interpolateCatmullRom(c,g,
k,m,a):this._interpolateCardinal(c,g,k,m,a,this.tension)}return pc.math.lerp(g,k,a)},_interpolateHermite:function(a,b,c,d,f){var g=f*f,h=f*f*f;return a*(2*h-3*g+1)+b*(-2*h+3*g)+c*(h-2*g+f)+d*(h-g)},_interpolateCardinal:function(a,b,c,d,f,g){return this._interpolateHermite(b,c,g*(c-a),g*(d-b),f)},_interpolateCatmullRom:function(a,b,c,d,f){return this._interpolateCardinal(a,b,c,d,f,.5)},closest:function(a){for(var b=this.keys,c=b.length,d=2,f=null,g=0;g<c;g++){var h=Math.abs(a-b[g][0]);if(d>=h)d=h,
...
setFromTransformedAabb:function(a,b){var c=this.center,d=this.halfExtents,h=a.center.data,f=a.halfExtents.data;b=b.data;var g=b[0],e=b[4],q=b[8],t=b[1],x=b[5],y=b[9],w=b[2],u=b[6],v=b[10],B=Math.abs(g),A=Math.abs(e),C=Math.abs(q),z=Math.abs(t),F=Math.abs(x),I=Math.abs(y),G=Math.abs(w),H=Math.abs(u),D=Math.abs(v);c.set(b[12]+g*h[0]+e*h[1]+q*h[2],b[13]+t*h[0]+x*h[1]+y*h[2],b[14]+w*h[0]+u*h[1]+v*h[2]);d.set(B*f[0]+A*f[1]+C*f[2],z*f[0]+F*f[1]+I*f[2],G*f[0]+H*f[1]+D*f[2])},compute:function(b){for(var c=
e.set(b[0],b[1],b[2]),d=a.set(b[0],b[1],b[2]),f=b.length/3,g=1;g<f;g++){var l=b[3*g+0],r=b[3*g+1],p=b[3*g+2];l<c.x&&(c.x=l);r<c.y&&(c.y=r);p<c.z&&(c.z=p);l>d.x&&(d.x=l);r>d.y&&(d.y=r);p>d.z&&(d.z=p)}this.setMinMax(c,d)},intersectsBoundingSphere:function(a){return this._distanceToBoundingSphereSq(a)<=a.radius*a.radius?!0:!1},_distanceToBoundingSphereSq:function(a){for(var b=this.getMin(),c=this.getMax(),d=0,f=0;3>f;++f){var g=0,e=a.center.data[f],p=b.data[f],q=c.data[f];e<p&&(p-=e,g+=p*p);e>q&&(p=
...
mipmaps:!1,minFilter:pc.FILTER_NEAREST,magFilter:pc.FILTER_NEAREST}),A=new pc.RenderTarget(this,l,{depth:!1});this.constantTexSource.setValue(m);pc.drawQuadWithShader(this,A,n);n=new Uint8Array(4);k.bindFramebuffer(k.FRAMEBUFFER,A._glFrameBuffer);k.readPixels(0,0,1,1,k.RGBA,k.UNSIGNED_BYTE,n);this.extTextureFloatHighPrecision=0===n[0]/255/16777216+n[1]/255/65536+n[2]/255/256+n[3]/255;m.destroy();r.destroy();l.destroy();A.destroy();pc.destroyPostEffectQuad();k.bindFramebuffer(k.FRAMEBUFFER,null)}pc.extTextureFloatRenderable=
...
!0):this.instancedAttribs[k]&&(this.extInstancing.vertexAttribDivisorANGLE(k,0),this.instancedAttribs[k]=!1));this.attributesInvalidated=!1}var u=0;d=0;for(h=y.length;d<h;d++)if(g=y[d],e=g.scopeId.value)if(e instanceof pc.Texture)k=e,this.setTexture(k,u),g.slot!==u&&(c.uniform1i(g.locationId,u),g.slot=u),u++;else{g.array.length=0;x=e.length;for(f=0;f<x;f++)k=e[f],this.setTexture(k,u),g.array[f]=u,u++;c.uniform1iv(g.locationId,g.array)}d=0;for(h=w.length;d<h;d++)if(y=w[d],f=y.scopeId,g=y.version,e=
...
k.end()}k=b.renderTarget;b.setRenderTarget(c);b.updateBegin();var m,n,l,r,p;f?(c=f.x,m=f.y,n=f.z,f=f.w):(n=c?c.width:b.width,f=c?c.height:b.height,m=c=0);g?(l=g.x,r=g.y,p=g.z,g=g.w):(l=c,r=m,p=n,g=f);b.setViewport(c,m,n,f);b.setScissor(l,r,p,g);g=b.getDepthTest();n=b.getDepthWrite();c=b.getCullMode();b.setDepthTest(!1);b.setDepthWrite(!1);b.setCullMode(pc.CULLFACE_NONE);h||b.setBlending(!1);b.setVertexBuffer(e,0);b.setShader(d);b.draw(a);b.setDepthTest(g);b.setDepthWrite(n);b.setCullMode(c);b.updateEnd();
b.setRenderTarget(k);b.updateBegin()},destroyPostEffectQuad:function(){e=null}}}());pc.extend(pc,function(){function e(a,c,d){var b=c._colorBuffer;if(b.format==pc.PIXELFORMAT_R8_G8_B8_A8){var g=new Uint8Array(b.width*b.height*4),h=a.gl;a.setFramebuffer(c._glFrameBuffer);h.readPixels(0,0,b.width,b.height,h.RGBA,h.UNSIGNED_BYTE,g);b._levels||(b._levels=[]);b._levels[0]||(b._levels[0]=[]);b._levels[0][d]=g}}function a(a,c){return Math.atan2(a*c,Math.sqrt(a*a+c*c+1))}return{prefilterCubemap:function(a){var b=a.device,d=a.sourceCubemap,f=a.method,g=a.samples,h=a.cpuSync;if(h&&!d._levels[0])console.error("ERROR: prefilter: cubemap must have _levels");
else{var k=pc.shaderChunks,m=d.rgbm,g=k.createShaderFromCode(b,k.fullscreenQuadVS,k.rgbmPS+k.prefilterCubemapPS.replace(/\$METHOD/g,0===f?"cos":"phong").replace(/\$NUMSAMPLES/g,g).replace(/\$textureCube/g,m?"textureCubeRGBM":"textureCube"),"prefilter"+f+""+g+""+m),n=k.createShaderFromCode(b,k.fullscreenQuadVS,k.outputCubemapPS,"outputCubemap"),l=b.scope.resolve("source"),r=b.scope.resolve("params"),p=new pc.Vec4,q=d.width,k=d.format,t=[[],a.filteredFixed,a.filteredRgbm,a.filteredFixedRgbm],x=0===
f?[.9,.85,.7,.4,.25]:[512,128,32,8,2],y=[64,32,16,8,4],w,u,v;u=k===pc.PIXELFORMAT_R8_G8_B8;w=!1;var B;h&&(w=d._levels[0][0]instanceof HTMLImageElement);if((u||w)&&h){k=pc.PIXELFORMAT_R8_G8_B8_A8;B=new pc.gfx.Texture(b,{cubemap:!0,rgbm:m,format:k,width:q,height:q,mipmaps:!1});for(v=0;6>v;v++)w=new pc.RenderTarget(b,B,{face:v,depth:!1}),p.x=v,p.y=0,l.setValue(d),r.setValue(p.data),pc.drawQuadWithShader(b,w,n),e(b,w,v);d=B}if(128<q){var A=Math.round(Math.log2(q))-Math.round(Math.log2(128));for(u=0;u<
A;u++){var q=.5*d.width,C=0===f?1:Math.pow(2,Math.round(Math.log2(x[0])+2*(A-u)));B=new pc.gfx.Texture(b,{cubemap:!0,rgbm:m,format:k,width:q,height:q,mipmaps:!1});for(v=0;6>v;v++)w=new pc.RenderTarget(b,B,{face:v,depth:!1}),p.x=v,p.y=C,p.z=q,p.w=m?3:0,l.setValue(d),r.setValue(p.data),pc.drawQuadWithShader(b,w,n),u===A-1&&h&&e(b,w,v);d=B}}a.sourceCubemap=d;B=null;if(!m&&a.filteredFixedRgbm)for(B=new pc.gfx.Texture(b,{cubemap:!0,rgbm:!0,format:pc.PIXELFORMAT_R8_G8_B8_A8,width:q,height:q,mipmaps:!1}),
v=0;6>v;v++)w=new pc.RenderTarget(b,B,{face:v,depth:!1}),p.x=v,p.w=2,l.setValue(d),r.setValue(p.data),pc.drawQuadWithShader(b,w,n),e(b,w,v);q=0===f?1:2048;w=0===f?0:-1;t[w]=[];for(u=0;5>u;u++)for(n=w;n<t.length;n++)null!=t[n]&&(t[n][u]=new pc.gfx.Texture(b,{cubemap:!0,rgbm:2>n?m:!0,format:2>n?k:pc.PIXELFORMAT_R8_G8_B8_A8,fixCubemapSeams:1===n||3===n,width:y[u],height:y[u],mipmaps:!1}));for(n=w;n<t.length;n++)if(null!=t[n])if(1<n&&m)t[n]=t[n-2];else for(u=0;5>u;u++)for(v=0;6>v;v++)w=new pc.RenderTarget(b,
t[n][u],{face:v,depth:!1}),p.x=v,p.y=0>n?q:x[u],p.z=y[u],p.w=m?3:n,l.setValue(0===u?d:0===f?t[0][u-1]:t[-1][u-1]),r.setValue(p.data),pc.drawQuadWithShader(b,w,g),h&&e(b,w,v);a.filtered=t[0];if(h&&a.singleFilteredFixed){d=[d,a.filteredFixed[0],a.filteredFixed[1],a.filteredFixed[2],a.filteredFixed[3],a.filteredFixed[4],a.filteredFixed[5]];m=new pc.gfx.Texture(b,{cubemap:!0,rgbm:m,fixCubemapSeams:!0,format:k,width:128,height:128,addressU:pc.ADDRESS_CLAMP_TO_EDGE,addressV:pc.ADDRESS_CLAMP_TO_EDGE});for(u=
0;6>u;u++)m._levels[u]=d[u]._levels[0];m.upload();m._prefilteredMips=!0;a.singleFilteredFixed=m}if(h&&a.singleFilteredFixedRgbm&&a.filteredFixedRgbm){d=[B,a.filteredFixedRgbm[0],a.filteredFixedRgbm[1],a.filteredFixedRgbm[2],a.filteredFixedRgbm[3],a.filteredFixedRgbm[4],a.filteredFixedRgbm[5]];m=new pc.gfx.Texture(b,{cubemap:!0,rgbm:!0,fixCubemapSeams:!0,format:pc.PIXELFORMAT_R8_G8_B8_A8,width:128,height:128,addressU:pc.ADDRESS_CLAMP_TO_EDGE,addressV:pc.ADDRESS_CLAMP_TO_EDGE});for(u=0;6>u;u++)m._levels[u]=
...
for(d=0;6>d;d++){var n=b._levels[0][d],l=new pc.Texture(g,{cubemap:!1,rgbm:!1,format:b.format,width:f,height:f,mipmaps:!1});l._levels[0]=n;l.upload();n=new pc.Texture(g,{cubemap:!1,rgbm:!1,format:b.format,width:f,height:f,mipmaps:!1});n=new pc.RenderTarget(g,n,{depth:!1});m.setValue(l);pc.drawQuadWithShader(g,n,e);var r=new Uint8Array(f*f*4);h.bindFramebuffer(h.FRAMEBUFFER,n._glFrameBuffer);h.readPixels(0,0,l.width,l.height,h.RGBA,h.UNSIGNED_BYTE,r);b._levels[0][d]=r}}else{console.error("ERROR: SH: cubemap must be composed of arrays or images");
return}e=[];for(h=0;h<f;h++)for(g=0;g<f;g++)e[h*f+g]=(new pc.Vec3(g/(f-1)*2-1,h/(f-1)*2-1,1)).normalize();var m=new Float32Array(27),p,q,t,x,y,w,u,v,B,A,C;for(d=n=0;6>d;d++)for(h=0;h<f;h++)for(g=0;g<f;g++){l=h*f+g;r=g;u=h;v=f;q=(2*(r+.5)/v-1)*(1-1/v);C=(2*(u+.5)/v-1)*(1-1/v);p=1/v;B=q-p;A=C-p;q+=p;C+=p;B=a(B,A)-a(B,C)-a(q,A)+a(q,C);if(0===r&&0===u||r===v-1&&0===u||0===r&&u===v-1||r===v-1&&u===v-1)B/=3;else if(0===r||0===u||r===v-1||u===v-1)B*=.5;r=B;u=4*r/17;v=8*r/17;B=15*r/17;A=5*r/68;C=15*r/68;
p=e[l];0==d?(x=p.z,y=-p.y,w=-p.x):1==d?(x=-p.z,y=-p.y,w=p.x):2==d?(x=p.x,y=p.z,w=p.y):3==d?(x=p.x,y=-p.z,w=-p.y):4==d?(x=p.x,y=-p.y,w=p.z):5==d&&(x=-p.x,y=-p.y,w=-p.z);c||(x=-x);q=b._levels[0][d][4*l+3]/255;for(p=0;3>p;p++)t=b._levels[0][d][4*l+p]/255,b.rgbm?(t*=8*q,t*=t):t=Math.pow(t,2.2),m[0+p]+=t*u,m[3+p]+=t*v*x,m[6+p]+=t*v*y,m[9+p]+=t*v*w,m[12+p]+=t*B*x*w,m[15+p]+=t*B*w*y,m[18+p]+=t*B*y*x,m[21+p]+=t*A*(3*w*w-1),m[24+p]+=t*C*(x*x-y*y),n+=r}for(p=0;p<m.length;p++)m[p]*=4*Math.PI/n;return m}console.error("ERROR: SH: cubemap must be synced to CPU")}}}}());pc.extend(pc,function(){return{paraboloidFromCubemap:function(e,a,b,c){var d=pc.shaderChunks,d=d.createShaderFromCode(e,d.fullscreenQuadVS,(a.fixCubemapSeams?d.fixCubemapSeamsStretchPS:d.fixCubemapSeamsNonePS)+d.genParaboloidPS,"genParaboloid"),f=e.scope.resolve("source"),g=e.scope.resolve("params"),h=new pc.Vec4,k=a.width,m=a.rgbm,n=a.format,k=2*Math.max(k,8),k=new pc.gfx.Texture(e,{rgbm:m,format:n,width:2*k,height:k,mipmaps:!1}),m=new pc.RenderTarget(e,k,{depth:!1});h.x=b;h.y=c?-1:1;f.setValue(a);
g.setValue(h.data);pc.drawQuadWithShader(e,m,d);return k},generateDpAtlas:function(e,a,b){var c,d;d=new pc.Vec4;for(var f=new pc.Vec4,g=4*a[0].width,h=pc.shaderChunks,h=h.createShaderFromCode(e,h.fullscreenQuadVS,h.dpAtlasQuadPS,"dpAtlasQuad"),k=e.scope.resolve("source"),m=e.scope.resolve("params"),n=new pc.gfx.Texture(e,{rgbm:a[0].rgbm,format:a[0].format,width:g,height:g,mipmaps:!1}),l=new pc.RenderTarget(e,n,{depth:!1}),r=(g+2)/g-1,p=0;6>p;p++){c=pc.paraboloidFromCubemap(e,a[p],p,b);k.setValue(c);
c=d;var q=p;c.x=.5*pc.math.clamp(q-2,0,1);var q=q-6*c.x,t=1-c.x;c.y=Math.min(.5*q,.75)*t+c.x;c.z=(1-.5*pc.math.clamp(q,0,1))*t;c.w=.5*c.z;c=1/c.z;f.x=c*r;f.y=2*f.x;f.x+=1;f.y+=1;m.setValue(f.data);d.x*=g;d.y*=g;d.z*=g;d.w*=g;pc.drawQuadWithShader(e,l,h,d)}return n}}}());pc.shaderChunks.TBNPS="void getTBN() {\n    dTBN = mat3(normalize(dTangentW), normalize(dBinormalW), normalize(dVertexNormalW));\n}\n";pc.shaderChunks.TBNfastPS="void getTBN() {\n    dTBN = mat3(dTangentW, dBinormalW, dVertexNormalW);\n}\n";pc.shaderChunks.alphaTestPS="uniform float alpha_ref;\nvoid alphaTest(float a) {\n    if (a < alpha_ref) discard;\n}\n";pc.shaderChunks.ambientConstantPS="\nvoid addAmbient() {\n    dDiffuseLight += light_globalAmbient;\n}\n";
...
0<=t.indexOf("vertex_boneIndices")&&(x.vertex_boneIndices=pc.SEMANTIC_BLENDINDICES),y[c]=t):y[c]=q[c]);for(c in a.chunks)(q=this._oldChunkToNew[c])&&(y[q.n]=q.f(a.chunks[c],q.n,c));q=y}l+=q.baseVS;y=-1;if(!a.noShadow&&!a.twoSidedLighting){for(b=0;b<a.lights.length;b++)if(t=a.lights[b]._type,a.lights[b].castShadows&&t===pc.LIGHTTYPE_DIRECTIONAL){l+="uniform mat4 light"+b+"_shadowMatrixVS;\n";l+="uniform vec3 light"+b+"_shadowParamsVS;\n";l+="uniform vec3 light"+b+(t===pc.LIGHTTYPE_DIRECTIONAL?"_directionVS":
"_positionVS")+";\n";y=b;break}0<=y&&(l+=q.shadowCoordVS)}r+="   vPositionW    = getWorldPosition();\n";a.pass===pc.SHADER_DEPTH&&(l+="varying float vDepth;\n#ifndef VIEWMATRIX\n#define VIEWMATRIX\nuniform mat4 matrix_view;\n#endif\n#ifndef CAMERAPLANES\n#define CAMERAPLANES\nuniform vec4 camera_params;\n\n#endif\n",r+="    vDepth = -(matrix_view * vec4(vPositionW,1.0)).z * camera_params.x;\n");a.useInstancing&&(x.instance_line1=pc.SEMANTIC_TEXCOORD2,x.instance_line2=pc.SEMANTIC_TEXCOORD3,x.instance_line3=
pc.SEMANTIC_TEXCOORD4,x.instance_line4=pc.SEMANTIC_TEXCOORD5,l+=q.instancingVS);m&&(x.vertex_normal=pc.SEMANTIC_NORMAL,r+="   vNormalW    = dNormalW = getNormal();\n",a.sphereMap&&16>=e.fragmentUniformsCount&&(l+=q.viewNormalVS,r+="   vNormalV    = getViewNormal();\n"),(a.heightMap||a.normalMap)&&h&&(x.vertex_tangent=pc.SEMANTIC_TANGENT,l+=q.tangentBinormalVS,r+="   vTangentW   = getTangent();\n   vBinormalW  = getBinormal();\n"),0<=y&&(t=a.lights[y]._type,r=t===pc.LIGHTTYPE_DIRECTIONAL?r+("   dLightDirNormW = light"+
y+"_directionVS;\n"):r+("   getLightDirPoint(light"+y+"_positionVS);\n"),r+=this._nonPointShadowMapProjection(e,a.lights[y],"(light"+y+"_shadowMatrixVS, light"+y+"_shadowParamsVS);\n")));t=[];var w=[],u,v,B;for(c in pc._matTex2D)b=c+"Map",a[c+"VertexColor"]&&(u=c+"VertexColorChannel",a[u]=this._correctChannel(c,a[u])),a[b]&&(u=b+"Channel",v=b+"Transform",B=b+"Uv",a[B]=Math.min(a[B],1),a[u]=this._correctChannel(c,a[u]),B=a[B],t[B]=!0,w[B]=w[B]||a[b]&&!a[v]);a.forceUv1&&(t[1]=!0);for(b=0;2>b;b++)t[b]&&
(x["vertex_texCoord"+b]=pc["SEMANTIC_TEXCOORD"+b],l+=q["uv"+b+"VS"],r+="   vec2 uv"+b+" = getUv"+b+"();\n"),w[b]&&(r+="   vUv"+b+" = uv"+b+";\n");t=[l,p,r,[]];for(c in pc._matTex2D)b=c+"Map",a[b]&&(v=b+"Transform",a[v]&&(B=b+"Uv",this._setMapTransform(t,c,a[v],a[B])));l=t[0];p=t[1];r=t[2];a.vertexColors&&(x.vertex_color=pc.SEMANTIC_COLOR,r+="   vVertexColor = vertex_color;\n");a.skin?(x.vertex_boneWeights=pc.SEMANTIC_BLENDWEIGHT,x.vertex_boneIndices=pc.SEMANTIC_BLENDINDICES,l+=pc.programlib.skinCode(e,
q),l+="#define SKIN\n"):a.useInstancing&&(l+="#define INSTANCING\n");a.screenSpace&&(l+="#define SCREENSPACE\n");a.pixelSnap&&(l+="#define PIXELSNAP\n");l+=q.transformVS;m&&(l+=q.normalVS);l=l+"\n"+q.startVS;c=l=l+r+"}";t=p;p=""+this._addVaryingIfNeeded(l,"vec4","vMainShadowUv");p+=this._addVaryingIfNeeded(l,"vec4","vVertexColor");p+=this._addVaryingIfNeeded(l,"vec3","vPositionW");p+=this._addVaryingIfNeeded(l,"vec3","vNormalV");p+=this._addVaryingIfNeeded(l,"vec3","vNormalW");p+=this._addVaryingIfNeeded(l,
"vec3","vTangentW");p+=this._addVaryingIfNeeded(l,"vec3","vBinormalW");p+=this._addVaryingIfNeeded(l,"vec2","vUv0");p+=this._addVaryingIfNeeded(l,"vec2","vUv1");p+=t;c=p+c;l="";e.webgl2?(l=pc.programlib.versionCode(e),q.extensionVS&&(l+=q.extensionVS+"\n"),c=l+q.gles3VS+c):(q.extensionVS&&(l=q.extensionVS+"\n"),c=l+c);a.forceFragmentPrecision&&"highp"!=a.forceFragmentPrecision&&"mediump"!==a.forceFragmentPrecision&&"lowp"!==a.forceFragmentPrecision&&(a.forceFragmentPrecision=null);a.forceFragmentPrecision&&
("highp"===a.forceFragmentPrecision&&"highp"!==e.maxPrecision&&(a.forceFragmentPrecision="mediump"),"mediump"===a.forceFragmentPrecision&&"lowp"===e.maxPrecision&&(a.forceFragmentPrecision="lowp"));l="";e.webgl2&&(l+=pc.programlib.versionCode(e));e.extStandardDerivatives&&!e.webgl2&&(l+="#extension GL_OES_standard_derivatives : enable\n\n");q.extensionPS&&(l+=q.extensionPS+"\n");e.webgl2&&(l+=q.gles3PS);l+=a.forceFragmentPrecision?"precision "+a.forceFragmentPrecision+" float;\n\n":pc.programlib.precisionCode(e);
if(a.pass===pc.SHADER_PICK)return l=l+"uniform vec4 uColor;"+p,a.alphaTest&&(l=l+"float dAlpha;\n"+this._addMap("opacity",a,q,""),l+=q.alphaTestPS),l+=pc.programlib.begin(),a.alphaTest&&(l+="   getOpacity();\n   alphaTest(dAlpha);\n"),l=l+"    gl_FragColor = uColor;\n"+pc.programlib.end(),{attributes:x,vshader:c,fshader:l};if(a.pass===pc.SHADER_DEPTH)return l=l+"varying float vDepth;\n"+p+q.packDepthPS,a.alphaTest&&(l+="float dAlpha;\n",l+=this._addMap("opacity",a,q,""),l+=q.alphaTestPS),l+=pc.programlib.begin(),
...
q.TBNfastPS:q.TBNPS;m&&(a.normalMap&&h?(l+=a.packedNormal?q.normalXYPS:q.normalXYZPS,h=this._uvSource(a.normalMapTransform,a.normalMapUv)+t,l=a.needsNormalFloat?l+(a.fastTbn?q.normalMapFloatTBNfastPS:q.normalMapFloatPS).replace(/\$UV/g,h):l+q.normalMapPS.replace(/\$UV/g,h),l+=b):l+=q.normalVertexPS);l+=pc.programlib.gammaCode(a.gamma);l+=pc.programlib.tonemapCode(a.toneMap);l+=pc.programlib.fogCode(a.fog);a.useRgbm&&(l+=q.rgbmPS);if(f||a.prefilteredCubemap)l+=a.fixSeams?q.fixCubemapSeamsStretchPS:
q.fixCubemapSeamsNonePS;m&&(l+=0<a.cubeMapProjection?q.cubeMapProjectBoxPS:q.cubeMapProjectNonePS,l+=a.skyboxIntensity?q.envMultiplyPS:q.envConstPS);l+=this._addMap("diffuse",a,q,t);if(a.blendType!==pc.BLEND_NONE||a.alphaTest||a.alphaToCoverage)l+=this._addMap("opacity",a,q,t);l+=this._addMap("emissive",a,q,t,null,a.emissiveFormat);a.useSpecular&&(d||g)&&(l=a.specularAntialias&&a.normalMap?a.needsNormalFloat&&m?l+q.specularAaToksvigFloatPS:l+q.specularAaToksvigPS:l+q.specularAaNonePS,l+=this._addMap(a.useMetalness?
"metalness":"specular",a,q,t),l+=this._addMap("gloss",a,q,t),0<a.fresnelModel&&(a.fresnelModel===pc.FRESNEL_SIMPLE?l+=q.fresnelSimplePS:a.fresnelModel===pc.FRESNEL_SCHLICK?l+=q.fresnelSchlickPS:a.fresnelModel===pc.FRESNEL_COMPLEX&&(l+=q.fresnelComplexPS)));a.heightMap&&(a.normalMap||(l+=b),l+=this._addMap("height",a,q,"",q.parallaxPS));if(h=a.aoMap||a.aoVertexColor)l+=this._addMap("ao",a,q,t,a.aoVertexColor?q.aoVertPS:q.aoTexPS),a.occludeSpecular&&(l=a.occludeSpecular===pc.SPECOCC_AO?l+(a.occludeSpecularFloat?
q.aoSpecOccSimplePS:q.aoSpecOccConstSimplePS):l+(a.occludeSpecularFloat?q.aoSpecOccPS:q.aoSpecOccConstPS));b=a.rgbmReflection?"decodeRGBM":a.hdrReflection?"":"gammaCorrectInput";f&&(l=a.prefilteredCubemap?k?l+q.reflectionPrefilteredCubeLodPS.replace(/\$DECODE/g,b):l+q.reflectionPrefilteredCubePS.replace(/\$DECODE/g,b):l+q.reflectionCubePS.replace(/\$textureCubeSAMPLE/g,a.rgbmReflection?"textureCubeRGBM":a.hdrReflection?"textureCube":"textureCubeSRGB"));a.sphereMap&&(b=16<e.fragmentUniformsCount?q.reflectionSpherePS:
q.reflectionSphereLowPS,b=b.replace(/\$texture2DSAMPLE/g,a.rgbmReflection?"texture2DRGBM":a.hdrReflection?"texture2D":"texture2DSRGB"),l+=b);a.dpAtlas&&(l+=q.reflectionDpAtlasPS.replace(/\$texture2DSAMPLE/g,a.rgbmReflection?"texture2DRGBM":a.hdrReflection?"texture2D":"texture2DSRGB"));(f||a.sphereMap||a.dpAtlas)&&a.refraction&&(l+=q.refractionPS);0<r&&(w[pc.SHADOW_PCF3]&&(l+=q.shadowStandardPS),w[pc.SHADOW_PCF5]&&(l+=q.shadowStandardGL2PS),v&&(l+=q.shadowVSM_commonPS,w[pc.SHADOW_VSM8]&&(l+=q.shadowVSM8PS),
w[pc.SHADOW_VSM16]&&(l+=e.extTextureHalfFloatLinear?q.shadowEVSMPS.replace(/\$/g,"16"):q.shadowEVSMnPS.replace(/\$/g,"16")),w[pc.SHADOW_VSM32]&&(l+=e.extTextureFloatLinear?q.shadowEVSMPS.replace(/\$/g,"32"):q.shadowEVSMnPS.replace(/\$/g,"32"))),e.webgl2||e.extStandardDerivatives||(l+=q.biasConstPS),l+=q.shadowCoordPS+q.shadowCommonPS,B&&(l+=q.shadowCoordPerspZbufferPS),0<=y&&(w[pc.SHADOW_PCF3]&&(l+=q.shadowStandardVSPS),w[pc.SHADOW_PCF5]&&(l+=q.shadowStandardGL2VSPS),v&&(w[pc.SHADOW_VSM8]&&(l+=q.shadowVSMVSPS.replace(/\$VSM/g,
"VSM8").replace(/\$/g,"8")),w[pc.SHADOW_VSM16]&&(l+=q.shadowVSMVSPS.replace(/\$VSM/g,"VSM16").replace(/\$/g,"16")),w[pc.SHADOW_VSM32]&&(l+=q.shadowVSMVSPS.replace(/\$VSM/g,"VSM32").replace(/\$/g,"32")))));d&&(l+=q.lightDiffuseLambertPS);b=!1;a.useSpecular?(d&&(l+=a.shadingModel===pc.SPECULAR_PHONG?q.lightSpecularPhongPS:q.lightSpecularBlinnPS),a.sphereMap||f||a.dpAtlas||0<a.fresnelModel?l=0<a.fresnelModel?a.conserveEnergy?l+q.combineDiffuseSpecularPS:l+q.combineDiffuseSpecularNoConservePS:l+q.combineDiffuseSpecularOldPS:
a.diffuseMap?l+=q.combineDiffuseSpecularNoReflPS:(l+=q.combineDiffuseSpecularNoReflSeparateAmbientPS,b=!0)):l+=q.combineDiffusePS;n=!0;if(a.lightMap||a.lightVertexColor)l+=this._addMap("light",a,q,t,a.dirLightMap?q.lightmapDirPS:q.lightmapSinglePS,a.lightMapFormat),n=a.lightMapWithoutAmbient;n&&(t=a.rgbmAmbient?"decodeRGBM":a.hdrAmbient?"":"gammaCorrectInput",l=a.ambientSH?l+q.ambientSHPS:a.prefilteredCubemap?k?l+q.ambientPrefilteredCubeLodPS.replace(/\$DECODE/g,t):l+q.ambientPrefilteredCubePS.replace(/\$DECODE/g,
t):l+q.ambientConstantPS);a.ambientTint&&!b&&(l+="uniform vec3 material_ambient;\n");a.alphaTest&&(l+=q.alphaTestPS);a.msdf&&(l+=q.msdfPS);m&&(l+=q.viewDirPS,a.useSpecular&&(l+=q.reflDirPS));B=v=w=r=k=!1;l+=q.startPS;m&&(l=a.twoSidedLighting?l+"   dVertexNormalW = gl_FrontFacing ? vNormalW : -vNormalW;\n":l+"   dVertexNormalW = vNormalW;\n",a.heightMap||a.normalMap)&&(a.twoSidedLighting?(l+="   dTangentW = gl_FrontFacing ? vTangentW : -vTangentW;\n",l+="   dBinormalW = gl_FrontFacing ? vBinormalW : -vBinormalW;\n"):
...
b+"_innerConeAngle, light"+b+"_outerConeAngle);\n",v=!0)),l+="       dAtten *= getLightDiffuse();\n",n.castShadows&&!a.noShadow&&(n._shadowType===pc.SHADOW_VSM8?(m="VSM8",A="0.0"):n._shadowType===pc.SHADOW_VSM16?(m="VSM16",A="5.54"):n._shadowType===pc.SHADOW_VSM32?(m="VSM32",A=e.extTextureFloatHighPrecision?"15.0":"5.54"):m=n._shadowType===pc.SHADOW_PCF5?"PCF5x5":"PCF3x3",null!==m&&(t===pc.LIGHTTYPE_POINT?(d="(light"+b+"_shadowMap, light"+b+"_shadowParams);\n",n._normalOffsetBias&&(l+="       normalOffsetPointShadow(light"+
b+"_shadowParams);\n"),l+="       dAtten *= getShadowPoint"+m+d):(y===b?m+="VS":(d="(light"+b+"_shadowMatrix, light"+b+"_shadowParams);\n",l+=this._nonPointShadowMapProjection(e,a.lights[b],d)),t===pc.LIGHTTYPE_SPOT&&(m="Spot"+m),l+="       dAtten *= getShadow"+m+"(light"+b+"_shadowMap, light"+b+"_shadowParams"+(n._isVsm?", "+A:"")+");\n"))),l+="       dDiffuseLight += dAtten * light"+b+"_color"+(g?" * dAtten3":"")+";\n",a.useSpecular&&(l+="       dAtten *= getLightSpecular();\n",l+="       dSpecularLight += dAtten * light"+
b+"_color"+(g?" * dAtten3":"")+";\n"),t!==pc.LIGHTTYPE_DIRECTIONAL&&(l+="   }\n"),l+="\n";(f||a.sphereMap||a.dpAtlas)&&a.refraction&&(l+="   addRefraction();\n")}l+="\n";h&&(a.occludeDirect&&(l+="    applyAO();\n"),a.occludeSpecular&&(l+="    occludeSpecular();\n"));l+=q.endPS;l=a.blendType===pc.BLEND_NORMAL||a.blendType===pc.BLEND_ADDITIVEALPHA||a.alphaToCoverage?l+q.outputAlphaPS:a.blendType===pc.BLEND_PREMULTIPLIED?l+q.outputAlphaPremulPS:l+q.outputAlphaOpaquePS;a.msdf&&(l+="   gl_FragColor = applyMsdf(gl_FragColor);\n");
l+="\n";l+=pc.programlib.end();k&&(l=q.lightDirPointPS+l);r&&(l=q.falloffLinearPS+l);w&&(l=q.falloffInvSquaredPS+l);v&&(l=q.spotPS+l);B&&(l=q.cookiePS+l);q="";l.includes("dReflection")&&(q+="vec4 dReflection;\n");l.includes("dTBN")&&(q+="mat3 dTBN;\n");l.includes("dAlbedo")&&(q+="vec3 dAlbedo;\n");l.includes("dEmission")&&(q+="vec3 dEmission;\n");l.includes("dNormalW")&&(q+="vec3 dNormalW;\n");l.includes("dVertexNormalW")&&(q+="vec3 dVertexNormalW;\n");l.includes("dTangentW")&&(q+="vec3 dTangentW;\n");
l.includes("dBinormalW")&&(q+="vec3 dBinormalW;\n");l.includes("dViewDirW")&&(q+="vec3 dViewDirW;\n");l.includes("dReflDirW")&&(q+="vec3 dReflDirW;\n");l.includes("dDiffuseLight")&&(q+="vec3 dDiffuseLight;\n");l.includes("dSpecularLight")&&(q+="vec3 dSpecularLight;\n");l.includes("dLightDirNormW")&&(q+="vec3 dLightDirNormW;\n");l.includes("dLightDirW")&&(q+="vec3 dLightDirW;\n");l.includes("dLightPosW")&&(q+="vec3 dLightPosW;\n");l.includes("dShadowCoord")&&(q+="vec3 dShadowCoord;\n");l.includes("dNormalMap")&&
(q+="vec3 dNormalMap;\n");l.includes("dSpecularity")&&(q+="vec3 dSpecularity;\n");l.includes("dUvOffset")&&(q+="vec2 dUvOffset;\n");l.includes("dGlossiness")&&(q+="float dGlossiness;\n");l.includes("dAlpha")&&(q+="float dAlpha;\n");l.includes("dAtten")&&(q+="float dAtten;\n");l.includes("dAtten3")&&(q+="vec3 dAtten3;\n");l.includes("dAo")&&(q+="float dAo;\n");l.includes("dMsdf")&&(q+="vec4 dMsdf;\n");l=p+q+l;return{attributes:x,vshader:c,fshader:l,tag:pc.SHADERTAG_MATERIAL}}};pc.programlib.skybox={generateKey:function(e,a){return"skybox"+a.rgbm+" "+a.hdr+" "+a.fixSeams+""+a.toneMapping+""+a.gamma+""+a.useIntensity+""+a.mip},createShaderDefinition:function(e,a){var b=pc.shaderChunks;return{attributes:{aPosition:pc.SEMANTIC_POSITION},vshader:b.skyboxVS,fshader:pc.programlib.precisionCode(e)+(a.mip?b.fixCubemapSeamsStretchPS:b.fixCubemapSeamsNonePS)+(a.useIntensity?b.envMultiplyPS:b.envConstPS)+pc.programlib.gammaCode(a.gamma)+pc.programlib.tonemapCode(a.toneMapping)+b.rgbmPS+
...
a.data[4]=b.data[5];a.data[5]=b.data[6];a.data[6]=b.data[8];a.data[7]=b.data[9];a.data[8]=b.data[10]}for(var k=(new pc.Mat4).mul2((new pc.Mat4).setTranslate(.5,.5,.5),(new pc.Mat4).setScale(.5,.5,.5)),m={r:1,g:2,b:3,a:4},n=[(new pc.Quat).setFromEulerAngles(0,90,180),(new pc.Quat).setFromEulerAngles(0,-90,180),(new pc.Quat).setFromEulerAngles(90,0,0),(new pc.Quat).setFromEulerAngles(-90,0,0),(new pc.Quat).setFromEulerAngles(0,180,180),(new pc.Quat).setFromEulerAngles(0,0,180)],l=[{},{},{},{},{}],r=
new pc.Vec2,p={x:1,y:1,z:0,w:0},q=new pc.Mat4,t=new pc.Mat4,x=new pc.Mat4,y=new pc.Mat4,w=new pc.Mat4,u=new pc.Mat3,v=new pc.Mat4,B,A=new pc.Mat4,C=new pc.Mat4,z=new pc.Mat4,F=new pc.Mat4,I=new pc.Vec3,G=new pc.Vec3,H,D,E=new pc.Mat4,J=new pc.Mat4,Z=new pc.Mat4,Y=new pc.Mat4,W=new pc.Vec3,Q={center:null,radius:0},O,T=new pc.BoundingBox,R=[0,0],U,aa,K,S,N={},P,ba,M=[],V=0;8>V;V++)M.push(new pc.Vec3);var L=[new pc.Vec3,new pc.Vec3,new pc.Vec3,new pc.Vec3,new pc.Vec3,new pc.Vec3,new pc.Vec3,new pc.Vec3];
...
c.renderTarget,d.width===b._shadowResolution&&d.height===b._shadowResolution||f(a,b);return c},updateCameraFrustum:function(a){if(a.vrDisplay&&a.vrDisplay.presenting){B=a.vrDisplay.combinedProj;var b=a._node.getParent();b?w.copy(b.getWorldTransform()).mul(a.vrDisplay.combinedViewInv).invert():w.copy(a.vrDisplay.combinedView);y.copy(w).invert();this.viewInvId.setValue(y.data)}else{B=a.getProjectionMatrix();a.overrideCalculateProjection&&a.calculateProjection(B,pc.VIEW_CENTER);if(a.overrideCalculateTransform)a.calculateTransform(y,
pc.VIEW_CENTER);else{var b=a._node.getPosition(),c=a._node.getRotation();y.setTRS(b,c,pc.Vec3.ONE);this.viewInvId.setValue(y.data)}w.copy(y).invert()}a.frustum.update(B,w)},setCamera:function(a,b,c,d){var f=a.vrDisplay;if(f&&f.presenting){H=f.leftProj;D=f.rightProj;B=f.combinedProj;a.overrideCalculateProjection&&(a.calculateProjection(H,pc.VIEW_LEFT),a.calculateProjection(D,pc.VIEW_RIGHT),a.calculateProjection(B,pc.VIEW_CENTER));if(a.overrideCalculateTransform)a.calculateTransform(A,pc.VIEW_LEFT),
a.calculateTransform(C,pc.VIEW_RIGHT),a.calculateTransform(y,pc.VIEW_CENTER),z.copy(A).invert(),F.copy(C).invert(),w.copy(y).invert();else{var g=a._node.getParent();if(g){var e=g.getWorldTransform();A.mul2(e,f.leftViewInv);C.mul2(e,f.rightViewInv);z.copy(A).invert();F.copy(C).invert();w.copy(g.getWorldTransform()).mul(f.combinedViewInv).invert()}else A.copy(f.leftViewInv),C.copy(f.rightViewInv),z.copy(f.leftView),F.copy(f.rightView),w.copy(f.combinedView)}h(E,z);h(J,F);Z.mul2(H,z);Y.mul2(D,F);I.data[0]=
A.data[12];I.data[1]=A.data[13];I.data[2]=A.data[14];G.data[0]=C.data[12];G.data[1]=C.data[13];G.data[2]=C.data[14]}else B=a.getProjectionMatrix(),a.overrideCalculateProjection&&a.calculateProjection(B,pc.VIEW_CENTER),this.projId.setValue(B.data),a.overrideCalculateTransform?a.calculateTransform(y,pc.VIEW_CENTER):(f=a._node.getPosition(),g=a._node.getRotation(),y.setTRS(f,g,pc.Vec3.ONE)),this.viewInvId.setValue(y.data),w.copy(y).invert(),this.viewId.setValue(w.data),h(u,w),this.viewId3.setValue(u.data),
v.mul2(B,w),this.viewProjId.setValue(v.data),this.viewPosId.setValue(a._node.getPosition().data);a.frustum.update(B,w);this.nearClipId.setValue(a._nearClip);this.farClipId.setValue(a._farClip);this.cameraParamsId.setValue(a._shaderParams.data);f=this.device;f.setRenderTarget(b);f.updateBegin();e=a.getRect();g=b?b.width:f.width;b=b?b.height:f.height;var k=Math.floor(e.x*g),m=Math.floor(e.y*b),l=Math.floor(e.width*g),e=Math.floor(e.height*b);f.setViewport(k,m,l,e);f.setScissor(k,m,l,e);c&&f.clear(a._clearOptions);
...
b,c){var d=a.length,f,g,h,e=0;this.mainLight=-1;var k=this.device.scope;for(f=0;f<d;f++)if(a[f]._mask&c){g=a[f];h=g._node.getWorldTransform();this.lightColorId[e]||this._resolveLight(k,e);this.lightColorId[e].setValue(b.gammaCorrection?g._linearFinalColor.data:g._finalColor.data);h.getY(g._direction).scale(-1);this.lightDirId[e].setValue(g._direction.normalize().data);if(g.castShadows){var m=g._isPcf&&this.device.webgl2?g._shadowCamera.renderTarget.depthBuffer:g._shadowCamera.renderTarget.colorBuffer;
g._isVsm?h=-2E-4:(h=g.shadowBias/g._shadowCamera._farClip*100,!this.device.webgl2&&this.device.extStandardDerivatives&&(h*=-100));var l=g._isVsm?g.vsmBias/(g._shadowCamera._farClip/7):g._normalOffsetBias;this.lightShadowMapId[e].setValue(m);this.lightShadowMatrixId[e].setValue(g._shadowMatrix.data);m=g._rendererParams;3!==m.length&&(m.length=3);m[0]=g._shadowResolution;m[1]=l;m[2]=h;this.lightShadowParamsId[e].setValue(m);0>this.mainLight&&(this.lightShadowMatrixVsId[e].setValue(g._shadowMatrix.data),
...
this.lightCookieOffsetId[d].setValue(c._cookieOffset.data)))},dispatchLocalLights:function(a,b,c,d,f){var g,h=a[pc.LIGHTTYPE_POINT];a=a[pc.LIGHTTYPE_SPOT];var e=h.length,k=a.length,m=d,l=this.device.scope;for(d=0;d<e;d++)g=h[d],g._mask&c&&!g.isStatic&&(this.dispatchPointLight(b,l,g,m),m++);h=0;if(f)for(g=f[h];g&&g._type===pc.LIGHTTYPE_POINT;)this.dispatchPointLight(b,l,g,m),m++,h++,g=f[h];for(d=0;d<k;d++)g=a[d],g._mask&c&&!g.isStatic&&(this.dispatchSpotLight(b,l,g,m),m++);if(f)for(g=f[h];g&&g._type===
pc.LIGHTTYPE_SPOT;)this.dispatchSpotLight(b,l,g,m),m++,h++,g=f[h]},cull:function(a,b,c){var d=0,f,g,h,e=b.length,k=a.cullingMask||4294967295;if(!a.frustumCulling){for(f=0;f<e;f++)if(g=b[f],g.visible||g.command)g.mask&&0===(g.mask&k)||(c[d]=g,d++,g.visibleThisFrame=!0);return d}for(f=0;f<e;f++)g=b[f],g.command?(c[d]=g,d++,g.visibleThisFrame=!0):g.visible&&(h=!0,g.mask&&0===(g.mask&k)||(g.cull&&(h=this._isVisible(a,g)),h&&(c[d]=g,d++,g.visibleThisFrame=!0)));return d},cullLights:function(a,b){var c,
...
a.supportsBoneTextures?(U=b.skinInstance.boneTexture,this.boneTextureId.setValue(U),R[0]=U.width,R[1]=U.height,this.boneTextureSizeId.setValue(R)):this.poseMatrixId.setValue(b.skinInstance.matrixPalette))},drawInstance:function(a,b,c,d,f){if(aa=b.instancingData){if(this._instancedDrawCalls++,this._removedByInstancing+=aa.count,a.setVertexBuffer(aa._buffer,1,aa.offset),a.draw(c.primitive[d],aa.count),aa._buffer===pc._autoInstanceBuffer)return b.instancingData=null,aa.count-1}else return K=b.node.worldTransform,
this.modelMatrixId.setValue(K.data),f&&(S=b.node.normalMatrix,b.node._dirtyNormal&&(K.invertTo3x3(S),S.transpose(),b.node._dirtyNormal=!1),this.normalMatrixId.setValue(S.data)),a.draw(c.primitive[d]),0},drawInstance2:function(a,b,c,d){if(aa=b.instancingData){if(this._instancedDrawCalls++,this._removedByInstancing+=aa.count,a.setVertexBuffer(aa._buffer,1,aa.offset),a.draw(c.primitive[d],aa.count),aa._buffer===pc._autoInstanceBuffer)return b.instancingData=null,aa.count-1}else return a.draw(c.primitive[d]),
0},renderShadows:function(a,b){var f=this.device,g,h,e,l,x,y,w,u,v,D,A,z,B,G,C=1<<pc.SHADER_SHADOW,F,H;for(g=0;g<a.length;g++)if(e=a[g],x=e._type,e.castShadows&&e._enabled&&(e._shadowCamera||this.getShadowCamera(f,e),e.shadowUpdateMode!==pc.SHADOWUPDATE_NONE&&e.visibleThisFrame)){y=this.getShadowCamera(f,e);w=y._node;u=0;v=1;if(x===pc.LIGHTTYPE_DIRECTIONAL){if(0>e._visibleLength[b])continue;u=e._visibleCameraSettings[b];w.setPosition(u.x,u.y,u.z);y.orthoHeight=u.orthoHeight;y.farClip=u.farClip;u=
b}else x===pc.LIGHTTYPE_SPOT?(this.viewPosId.setValue(w.getPosition().data),this.shadowMapLightRadiusId.setValue(e.attenuationEnd)):x===pc.LIGHTTYPE_POINT&&(this.viewPosId.setValue(w.getPosition().data),this.shadowMapLightRadiusId.setValue(e.attenuationEnd),v=6);x!==pc.LIGHTTYPE_POINT&&(q.setTRS(w.getPosition(),w.getRotation(),pc.Vec3.ONE).invert(),t.mul2(y.getProjectionMatrix(),q),e._shadowMatrix.mul2(k,t));f.webgl2?x===pc.LIGHTTYPE_POINT?f.setDepthBias(!1):(f.setDepthBias(!0),f.setDepthBiasValues(-1E3*
e.shadowBias,-1E3*e.shadowBias)):f.extStandardDerivatives&&(x===pc.LIGHTTYPE_POINT?(this.polygonOffset[0]=0,this.polygonOffset[1]=0):(this.polygonOffset[0]=-1E3*e.shadowBias,this.polygonOffset[1]=-1E3*e.shadowBias),this.polygonOffsetId.setValue(this.polygonOffset));e.shadowUpdateMode===pc.SHADOWUPDATE_THISFRAME&&(e.shadowUpdateMode=pc.SHADOWUPDATE_NONE);this._shadowMapUpdates+=v;f.setBlending(!1);f.setDepthWrite(!0);f.setDepthTest(!0);e._isPcf&&f.webgl2&&x!==pc.LIGHTTYPE_POINT?f.setColorWrite(!1,
!1,!1,!1):f.setColorWrite(!0,!0,!0,!0);for(u?v=u+1:u=0;u<v;){x===pc.LIGHTTYPE_POINT&&(w.setRotation(n[u]),y.renderTarget=e._shadowCubeMap[u]);this.setCamera(y,y.renderTarget,!0,x!==pc.LIGHTTYPE_POINT);G=e._visibleList[u];A=e._visibleLength[u];h=e._shadowType;D=h+5*x;for(h=0;h<A;h++){z=G[h];B=z.mesh;l=z.material;this.setBaseConstants(f,l);this.setSkinning(f,z,l);if(l.chunks){H=l.parameters;for(F in H)l=H[F],l.passFlags&C&&(l.scopeId||(l.scopeId=f.scope.resolve(F)),l.scopeId.setValue(l.data));H=z.parameters;
for(F in H)l=H[F],l.passFlags&C&&(l.scopeId||(l.scopeId=f.scope.resolve(F)),l.scopeId.setValue(l.data))}l=z._shader[pc.SHADER_SHADOW+D];if(!l){this.updateShader(z,z._shaderDefs,null,pc.SHADER_SHADOW+D);l=z._shader[pc.SHADER_SHADOW+D];H=z._key;var O=pc.SORTKEY_DEPTH,E=z.material,R=z.skinInstance?10:0,U=0;E.opacityMap&&(E=E.opacityMapChannel)&&(U=m[E]);H[O]=R+U}f.setShader(l);l=z.renderStyle;f.setVertexBuffer(z.morphInstance&&z.morphInstance._vertexBuffer?z.morphInstance._vertexBuffer:B.vertexBuffer,
0);f.setIndexBuffer(B.indexBuffer[l]);h+=this.drawInstance(f,z,B,l);this._shadowDrawCalls++}u++;x===pc.LIGHTTYPE_DIRECTIONAL&&(e._visibleLength[b]=-1)}e._isVsm&&(x=e._vsmBlurSize,1<x&&(y=y.renderTarget,w=d(f,e._shadowResolution,e._shadowType,1),v=e.vsmBlurMode,u=(e._shadowType===pc.SHADOW_VSM8?this.blurPackedVsmShader:this.blurVsmShader)[v][x],u||(this.blurVsmWeights[x]=c(x),u=pc.shaderChunks,(e._shadowType===pc.SHADOW_VSM8?this.blurPackedVsmShader:this.blurVsmShader)[v][x]=u=u.createShaderFromCode(this.device,
u.fullscreenQuadVS,"#define SAMPLES "+x+"\n"+(e._shadowType===pc.SHADOW_VSM8?this.blurPackedVsmShaderCode:this.blurVsmShaderCode)[v],"blurVsm"+v+""+x+""+(e._shadowType===pc.SHADOW_VSM8))),p.z=e._shadowResolution-2,p.w=p.z,this.sourceId.setValue(y.colorBuffer),r.x=1/e._shadowResolution,r.y=0,this.pixelOffsetId.setValue(r.data),v===pc.BLUR_GAUSSIAN&&this.weightId.setValue(this.blurVsmWeights[x]),pc.drawQuadWithShader(f,w,u,null,p),this.sourceId.setValue(w.colorBuffer),r.y=r.x,r.x=0,this.pixelOffsetId.setValue(r.data),
pc.drawQuadWithShader(f,y,u,null,p)))}f.webgl2?f.setDepthBias(!1):f.extStandardDerivatives&&(this.polygonOffset[0]=0,this.polygonOffset[1]=0,this.polygonOffsetId.setValue(this.polygonOffset))},updateShader:function(a,b,c,d,f){a.material._scene=this.scene;a.material.updateShader(this.device,this.scene,b,c,d,f);a._shader[d]=a.material.shader},renderForward:function(a,b,c,d,f,g,h,e){var k=this.device,m=this.scene,l=a.vrDisplay,n=1<<f;e=e?e._lightHash:0;var p,q,r,t,x,y,w,u,v=null,B,O,R=.5*k.width;for(p=
0;p<c;p++)if(q=b[p],!g||!q.mask||g&q.mask)if(q.command)q.command();else{r=q.mesh;t=q.material;x=q._shaderDefs;w=q.mask;this.setSkinning(k,q,t);t&&t===v&&x!==y&&(v=null);if(q.isStatic||B)v=null;if(t!==v){this._materialSwitches++;q._shader[f]&&q._shaderDefs===x&&q._lightHash===e||(q.isStatic?this.updateShader(q,x,q._staticLightList,f,d):(y=f+"_"+x+"_"+e,q._shader[f]=t.variants[y],q._shader[f]||(this.updateShader(q,x,null,f,d),t.variants[y]=q._shader[f])),q._shaderDefs=x,q._lightHash=e);k.setShader(q._shader[f]);
y=t.parameters;for(O in y)B=y[O],B.passFlags&n&&(B.scopeId||(B.scopeId=k.scope.resolve(O)),B.scopeId.setValue(B.data));v&&w===u||(u=this.dispatchDirectLights(d[pc.LIGHTTYPE_DIRECTIONAL],m,w),this.dispatchLocalLights(d,m,w,u,q._staticLightList));this.alphaTestId.setValue(t.alphaTest);k.setBlending(t.blend);t.blend&&(t.separateAlphaBlend?(k.setBlendFunctionSeparate(t.blendSrc,t.blendDst,t.blendSrcAlpha,t.blendDstAlpha),k.setBlendEquationSeparate(t.blendEquation,t.blendAlphaEquation)):(k.setBlendFunction(t.blendSrc,
t.blendDst),k.setBlendEquation(t.blendEquation)));k.setColorWrite(t.redWrite,t.greenWrite,t.blueWrite,t.alphaWrite);a._cullFaces?a._flipFaces?k.setCullMode(0<t.cull?t.cull===pc.CULLFACE_FRONT?pc.CULLFACE_BACK:pc.CULLFACE_FRONT:0):k.setCullMode(t.cull):k.setCullMode(pc.CULLFACE_NONE);k.setDepthWrite(t.depthWrite);k.setDepthTest(t.depthTest);k.setAlphaToCoverage(t.alphaToCoverage);t.depthBias||t.slopeDepthBias?(k.setDepthBias(!0),k.setDepthBiasValues(t.depthBias,t.slopeDepthBias)):k.setDepthBias(!1)}u=
q.stencilFront||t.stencilFront;v=q.stencilBack||t.stencilBack;u||v?(k.setStencilTest(!0),u===v?(k.setStencilFunc(u.func,u.ref,u.readMask),k.setStencilOperation(u.fail,u.zfail,u.zpass,u.writeMask)):(u?(k.setStencilFuncFront(u.func,u.ref,u.readMask),k.setStencilOperationFront(u.fail,u.zfail,u.zpass,u.writeMask)):(k.setStencilFuncFront(pc.FUNC_ALWAYS,0,255),k.setStencilOperationFront(pc.STENCILOP_KEEP,pc.STENCILOP_KEEP,pc.STENCILOP_KEEPP,255)),v?(k.setStencilFuncBack(v.func,v.ref,v.readMask),k.setStencilOperationBack(v.fail,
v.zfail,v.zpass,v.writeMask)):(k.setStencilFuncBack(pc.FUNC_ALWAYS,0,255),k.setStencilOperationBack(pc.STENCILOP_KEEP,pc.STENCILOP_KEEP,pc.STENCILOP_KEEP,255)))):k.setStencilTest(!1);y=q.parameters;for(O in y)B=y[O],B.passFlags&n&&(B.scopeId||(B.scopeId=k.scope.resolve(O)),B.scopeId.setValue(B.data));k.setVertexBuffer(q.morphInstance&&q.morphInstance._vertexBuffer?q.morphInstance._vertexBuffer:r.vertexBuffer,0);u=q.renderStyle;k.setIndexBuffer(r.indexBuffer[u]);h&&h(q,p);l&&l.presenting?(k.setViewport(0,
0,R,k.height),this.projId.setValue(H.data),this.viewInvId.setValue(A.data),this.viewId.setValue(z.data),this.viewId3.setValue(E.data),this.viewProjId.setValue(Z.data),this.viewPosId.setValue(I.data),p+=this.drawInstance(k,q,r,u,!0),this._forwardDrawCalls++,k.setViewport(R,0,R,k.height),this.projId.setValue(D.data),this.viewInvId.setValue(C.data),this.viewId.setValue(F.data),this.viewId3.setValue(J.data),this.viewProjId.setValue(Y.data),this.viewPosId.setValue(G.data),p+=this.drawInstance2(k,q,r,u)):
p+=this.drawInstance(k,q,r,u,!0);this._forwardDrawCalls++;if(p<c-1&&b[p+1].material===t)for(O in y)if(B=t.parameters[O])B.scopeId||(B.scopeId=k.scope.resolve(O)),B.scopeId.setValue(B.data);v=t;y=x;u=w;B=q.isStatic}k.updateEnd()},setupInstancing:function(a){pc._instanceVertexFormat||(pc._instanceVertexFormat=new pc.VertexFormat(a,[{semantic:pc.SEMANTIC_TEXCOORD2,components:4,type:pc.TYPE_FLOAT32},{semantic:pc.SEMANTIC_TEXCOORD3,components:4,type:pc.TYPE_FLOAT32},{semantic:pc.SEMANTIC_TEXCOORD4,components:4,
...
a.length=f.length;for(b=0;b<f.length;b++)a[b]=f[b]},prepareStaticMeshes:function(a,b){var c,d,f,g,h,e=this.device,k=a.length,m,l,n=[],p,q,r,t,x,y,u,w,v,D,B,z,A,G,C=new pc.Vec3,F=new pc.Vec3,H=new pc.BoundingBox,O=new pc.Mat4,E=[],R,U,I=[],K=[],T=[];for(c=0;c<k;c++)if(m=a[c],m.isStatic){p=m.aabb;T.length=0;for(R=pc.LIGHTTYPE_POINT;R<=pc.LIGHTTYPE_SPOT;R++)for(d=0;d<b.length;d++)l=b[d],l._type===R&&l._enabled&&l._mask&m.mask&&l.isStatic&&(I[d]||(I[d]=new pc.BoundingBox,l._node.getWorldTransform(),l.getBoundingSphere(Q),
I[d].center.copy(Q.center),I[d].halfExtents.x=Q.radius,I[d].halfExtents.y=Q.radius,I[d].halfExtents.z=Q.radius),I[d].intersects(p)&&T.push(d));if(0===T.length)n.push(m);else{p=m.mesh;R=p.vertexBuffer;l=p.indexBuffer[m.renderStyle];q=2===l.bytesPerIndex?new Uint16Array(l.lock()):new Uint32Array(l.lock());r=p.primitive[m.renderStyle].count/3;u=p.primitive[m.renderStyle].base;t=R.format.elements;x=R.format.size/4;p=new Float32Array(R.storage);for(f=0;f<t.length;f++)t[f].name===pc.SEMANTIC_POSITION&&
(y=t[f].offset/4);E.length=r;for(f=0;f<r;f++)E[f]=0;t=!1;K.length=6*r;for(f=0;f<r;f++){B=D=v=Number.MAX_VALUE;z=-Number.MAX_VALUE;A=-Number.MAX_VALUE;G=-Number.MAX_VALUE;for(g=0;3>g;g++)d=q[3*f+g+u],d=d*x+y,h=p[d],w=p[d+1],d=p[d+2],h<v&&(v=h),w<D&&(D=w),d<B&&(B=d),h>z&&(z=h),w>A&&(A=w),d>G&&(G=d);d=6*f;K[d]=v;K[d+1]=D;K[d+2]=B;K[d+3]=z;K[d+4]=A;K[d+5]=G}for(h=0;h<T.length;h++)for(d=T[h],O.copy(m.node.worldTransform).invert(),H.setFromTransformedAabb(I[d],O),w=H.getMin().data,v=H.getMax().data,g=1<<
h,f=0;f<r;f++)d=6*f,K[d]<=v[0]&&K[d+3]>=w[0]&&K[d+1]<=v[1]&&K[d+4]>=w[1]&&K[d+2]<=v[2]&&K[d+5]>=w[2]&&(E[f]|=g,t=!0);if(t){t={};for(f=0;f<r;f++)d=3*f+u,U=E[f],t[U]||(t[U]=[]),g=t[U],g.push(q[d]),g.push(q[d+1]),g.push(q[d+2]);for(U in t){g=t[U];q=new pc.IndexBuffer(e,l.format,g.length,l.usage);(2===q.bytesPerIndex?new Uint16Array(q.lock()):new Uint32Array(q.lock())).set(g);q.unlock();B=D=v=Number.MAX_VALUE;z=-Number.MAX_VALUE;A=-Number.MAX_VALUE;G=-Number.MAX_VALUE;for(f=0;f<g.length;f++)d=g[f],h=
p[d*x+y],w=p[d*x+y+1],d=p[d*x+y+2],h<v&&(v=h),w<D&&(D=w),d<B&&(B=d),h>z&&(z=h),w>A&&(A=w),d>G&&(G=d);C.set(v,D,B);F.set(z,A,G);f=new pc.BoundingBox;f.setMinMax(C,F);r=new pc.Mesh;r.vertexBuffer=R;r.indexBuffer[0]=q;r.primitive[0].type=pc.PRIMITIVE_TRIANGLES;r.primitive[0].base=0;r.primitive[0].count=g.length;r.primitive[0].indexed=!0;r.aabb=f;q=new pc.MeshInstance(m.node,r,m.material);q.isStatic=m.isStatic;q.visible=m.visible;q.layer=m.layer;q.castShadow=m.castShadow;q._receiveShadow=m._receiveShadow;
q.cull=m.cull;q.pick=m.pick;q.mask=m.mask;q.parameters=m.parameters;q._shaderDefs=m._shaderDefs;q._staticSource=m;q._staticLightList=m._staticLightList?m._staticLightList:[];for(f=0;f<T.length;f++)g=1<<f,U&g&&(r=b[T[f]],0>q._staticLightList.indexOf(r)&&q._staticLightList.push(r));q._staticLightList.sort(this.lightCompare);n.push(q)}}else n.push(m)}}else n.push(m);a.length=n.length;for(c=0;c<n.length;c++)a[c]=n[c]},updateShaders:function(a){var b,c=[];for(b=0;b<a.length;b++){var d=a[b];void 0!==d.material&&
...
d._lights),a._dirty=!0,b.updateShaders=!0,d._needsStaticPrepare=!1,d._staticPrepareDone=!0)}},cullLocalShadowmap:function(a,b){var c,d,f,g,h,e,k,m,l,p,q;d=a._type;if(d!==pc.LIGHTTYPE_DIRECTIONAL)for(a.visibleThisFrame=!0,f=this.getShadowCamera(this.device,a),f.projection=pc.PROJECTION_PERSPECTIVE,f.nearClip=a.attenuationEnd/1E3,f.farClip=a.attenuationEnd,f.aspectRatio=1,d===pc.LIGHTTYPE_SPOT?(f.fov=2*a._outerConeAngle,h=1):(f.fov=90,h=6),g=f._node,c=a._node,g.setPosition(c.getPosition()),d===pc.LIGHTTYPE_SPOT&&
(g.setRotation(c.getRotation()),g.rotateLocal(-90,0,0)),e=0;e<h;e++){d===pc.LIGHTTYPE_POINT&&(g.setRotation(n[e]),f.renderTarget=a._shadowCubeMap[e]);this.updateCameraFrustum(f);(l=a._visibleList[e])||(l=a._visibleList[e]=[]);c=p=a._visibleLength[e]=0;for(k=b.length;c<k;c++)m=b[c],q=!0,m.cull&&(q=this._isVisible(f,m)),q&&(l[p]=m,p++,m.visibleThisFrame=!0);a._visibleLength[e]=p;l.length!==p&&(l.length=p);l.sort(this.depthSortCompare)}},cullDirectionalShadowmap:function(a,b,c,d){var f,g,h,e,k,m,l,n,
p,r,t,y;g=this.device;a.visibleThisFrame=!0;g=this.getShadowCamera(g,a);h=g._node;e=a._node;h.setPosition(e.getPosition());h.setRotation(e.getRotation());h.rotateLocal(-90,0,0);n=a.shadowDistance||c._farClip;p=c._nearClip;f=c._fov*Math.PI/180;k=c._aspect;m=c._projection;t=m===pc.PROJECTION_PERSPECTIVE?Math.tan(f/2)*p:c._orthoHeight;r=t*k;M[0].x=r;M[0].y=-t;M[0].z=-p;M[1].x=r;M[1].y=t;M[1].z=-p;M[2].x=-r;M[2].y=t;M[2].z=-p;M[3].x=-r;M[3].y=-t;M[3].z=-p;m===pc.PROJECTION_PERSPECTIVE&&(t=Math.tan(f/
2)*n,r=t*k);M[4].x=r;M[4].y=-t;M[4].z=-n;M[5].x=r;M[5].y=t;M[5].z=-n;M[6].x=-r;M[6].y=t;M[6].z=-n;M[7].x=-r;M[7].y=-t;M[7].z=-n;k=W.sub2(M[0],M[6]).length();k=Math.max(k,W.sub2(M[4],M[6]).length());q.copy(h.getWorldTransform()).invert();x.copy(q).mul(c._node.worldTransform);for(f=0;8>f;f++)x.transformPoint(M[f],M[f]);n=p=c=1E6;r=t=m=-1E6;for(f=0;8>f;f++)l=M[f],l.x<n&&(n=l.x),l.x>r&&(r=l.x),l.y<p&&(p=l.y),l.y>t&&(t=l.y),l.z<c&&(c=l.z),l.z>m&&(m=l.z);f=k/a._shadowResolution;n=Math.floor((n-.5*(k-(r-
n)))/f)*f;p=Math.floor((p-.5*(k-(t-p)))/f)*f;n=.5*(n+k+n);p=.5*(p+k+p);h.translateLocal(n,p,1E5);g.projection=pc.PROJECTION_ORTHOGRAPHIC;g.nearClip=0;g.farClip=2E5;g.aspectRatio=1;g.orthoHeight=.5*k;this.updateCameraFrustum(g);t=!0;(m=a._visibleList[d])||(m=a._visibleList[d]=[]);f=k=a._visibleLength[d]=0;for(r=b.length;f<r;f++)y=b[f],l=!0,y.cull&&(l=this._isVisible(g,y)),l&&(m[k]=y,k++,y.visibleThisFrame=!0,l=y.aabb,t?(T.copy(l),t=!1):T.add(l));a._visibleLength[d]=k;m.length!==k&&(m.length=k);m.sort(this.depthSortCompare);
b=T.getMin();f=T.getMax();L[0].x=L[1].x=L[2].x=L[3].x=b.x;L[1].y=L[3].y=L[7].y=L[5].y=b.y;L[2].z=L[3].z=L[6].z=L[7].z=b.z;L[4].x=L[5].x=L[6].x=L[7].x=f.x;L[0].y=L[2].y=L[4].y=L[6].y=f.y;L[0].z=L[1].z=L[4].z=L[5].z=f.z;f=9999999999;b=-9999999999;for(m=0;8>m;++m)q.transformPoint(L[m],L[m]),k=L[m].z,k<f&&(f=k),k>b&&(b=k);m=b;f>c&&(c=f);h.setPosition(e.getPosition());h.translateLocal(n,p,m+.01);g.farClip=m-c;(e=a._visibleCameraSettings[d])||(e=a._visibleCameraSettings[d]={});a=h.getPosition().data;e.x=
...
b.width;this._screenSize.y=b.height;this._screenSize.z=1/b.width;this._screenSize.w=1/b.height;this.screenSizeId.setValue(this._screenSize.data)},renderComposition:function(a){var b=this.device,c,d=a._renderedRt,f=a._renderedByCam,g=a._renderedLayer,h,e,k,m,l,n,p,q;this.beginLayers(a);a._update()&pc.COMPUPDATED_LIGHTS&&(this.scene.updateShaders=!0);this.beginFrame(a);this.setSceneConstants();var r=0,t,x;for(h=0;h<a.layerList.length;h++)if(e=a.layerList[h],e.enabled&&a.subLayerEnabled[h])for(k=a.subLayerList[h],
t=e.instances,m=e.cameras,l=0;l<m.length;l++)if(c=m[l]){c.frameBegin(e.renderTarget);x=k?e.transparentMeshInstances:e.opaqueMeshInstances;q=p=!1;for(n=0;n<r;n++)if(f[n]===c&&(p=!0,g[n]===e)){q=!0;break}p||(this.updateCameraFrustum(c.camera),this._camerasRendered++);q||this.cullLights(c.camera,e._lights);p&&q||(f[r]=c,g[r]=e,r++);n=k?t.visibleTransparent[l]:t.visibleOpaque[l];if(!n.done){if(e.onPreCull)e.onPreCull(l);n.length=this.cull(c.camera,x,n.list);n.done=!0;if(e.onPostCull)e.onPostCull(l)}c.frameEnd()}for(h=
...
a._globalLightCameraIds[k][l]);this.gpuUpdate(a._meshInstances);this.renderShadows(a._sortedLights[pc.LIGHTTYPE_SPOT]);this.renderShadows(a._sortedLights[pc.LIGHTTYPE_POINT]);for(h=r=0;h<a._renderList.length;h++)if(e=a.layerList[a._renderList[h]],e.enabled&&a.subLayerEnabled[a._renderList[h]]){t=e.instances;k=a.subLayerList[a._renderList[h]];m=a._renderListCamera[h];(c=e.cameras[m])&&c.frameBegin(e.renderTarget);if(!k&&e.onPreRenderOpaque)e.onPreRenderOpaque(m);else if(k&&e.onPreRenderTransparent)e.onPreRenderTransparent(m);
...
b.push(this);for(c=0;c<d;++c)b=this._children[c].findByLabel(a,b);return b},_sync:function(){this._dirtyLocal&&(this.localTransform.setTRS(this.localPosition,this.localRotation,this.localScale),this._dirtyLocal=!1);if(this._dirtyWorld){if(null===this._parent)this.worldTransform.copy(this.localTransform);else if(this.scaleCompensation){var g,k=this._parent,m=this.localScale,n=k;if(n){for(;n&&n.scaleCompensation;)n=n._parent;n&&(n=n._parent)&&(g=n.worldTransform.getScale(),d.mul2(g,this.localScale),
m=d)}c.setFromMat4(k.worldTransform);b.mul2(c,this.localRotation);n=k.worldTransform;k.scaleCompensation&&(f.mul2(g,k.getLocalScale()),e.setTRS(k.worldTransform.getTranslation(a),c,f),n=e);n.transformPoint(this.localPosition,a);this.worldTransform.setTRS(a,b,m)}else this.worldTransform.mul2(this._parent.worldTransform,this.localTransform);this._dirtyWorld=!1}},syncHierarchy:function(){if(this._enabled){(this._dirtyLocal||this._dirtyWorld)&&this._sync();for(var a=0;a<this._children.length;a++)this._children[a].syncHierarchy()}},
...
set:function(a){this.dirtyShader=!0;this[t]=a}});Object.defineProperty(e.prototype,x.substring(1),{get:function(){return this[x]},set:function(a){this[x]!==a&&(this.dirtyShader=!0);this[x]=a}});a.push(m.substring(1));a.push(l.substring(1));a.push(n.substring(1));a.push(q.substring(1));a.push(r.substring(1));a.push(t.substring(1));a.push(x.substring(1));c.push(p)},h=[],k=function(b,c,g,k){var m="_"+c,l=c+"Uniform",n=c+"Intensity",p="_"+n;b[m]=g;b[l]=new Float32Array(3);Object.defineProperty(e.prototype,
...
!0;for(d=0;d<a.data.length;d++)if(this._mapXForms[b][c][d]!=a.data[d]){f=!1;break}if(f)return c+1}c=this._mapXForms[b].length;this._mapXForms[b][c]=[];for(d=0;d<a.data.length;d++)this._mapXForms[b][c][d]=a.data[d];return c+1},updateShader:function(a,b,c,d,f,g){!this._colorProcessed&&this._scene&&(this._colorProcessed=!0,this._processColor());this._mapXForms=[];var h=a.useTexCubeLod,e=!a.extTextureLod,k,m,l,n,p,q;this.useSkybox&&(k=b._skyboxPrefiltered[0],m=b._skyboxPrefiltered[1],l=b._skyboxPrefiltered[2],
n=b._skyboxPrefiltered[3],p=b._skyboxPrefiltered[4],q=b._skyboxPrefiltered[5]);var r=this.prefilteredCubeMap128||k;m=this.prefilteredCubeMap64||m;l=this.prefilteredCubeMap32||l;n=this.prefilteredCubeMap16||n;p=this.prefilteredCubeMap8||p;q=this.prefilteredCubeMap4||q;if(r){var t=r&&m&&l&&n&&p&&q;e&&t?(r.dpAtlas||(r.dpAtlas=pc.generateDpAtlas(a,[r,m,l,n,p,q]),r.sh=pc.shFromCubemap(n)),this.dpAtlas=r.dpAtlas,this.ambientSH=r.sh,this._setParameter("ambientSH[0]",this.ambientSH),this._setParameter("texture_sphereMap",
...
(b.dirLightMap=!0))),b.screenSpace=0!==(c&pc.SHADERDEF_SCREENSPACE),b.skin=0!==(c&pc.SHADERDEF_SKIN),b.useInstancing=0!==(c&pc.SHADERDEF_INSTANCING),f=0!==(c&pc.SHADERDEF_UV0),h=0!==(c&pc.SHADERDEF_UV1),k=0!==(c&pc.SHADERDEF_VCOLOR));for(var u in pc._matTex2D)if(r="opacity"===u,!r||this.blendType!==pc.BLEND_NONE||0!==this.alphaTest||this.alphaToCoverage)if(!e||r)r=u+"Map",q=u+"VertexColor","height"!==u&&this[q]&&k&&(m=u+"VertexColorChannel",b[q]=this[q],b[m]=this[m],b.vertexColors=!0),this[r]&&(q=
r+"Uv",m=!0,0!==this[q]||f||(m=!1),1!==this[q]||h||(m=!1),m&&(b[r]=!!this[r],l=r+"Transform",m=r+"Channel",b[l]=this._getMapTransformID(this[l],this[q]),b[m]=this[m],b[q]=this[q]));this._mapXForms=null;this.useLighting&&!e?(u=[],f=c?c>>16:1,g&&(this._collectLights(pc.LIGHTTYPE_DIRECTIONAL,g[pc.LIGHTTYPE_DIRECTIONAL],u,f),this._collectLights(pc.LIGHTTYPE_POINT,g[pc.LIGHTTYPE_POINT],u,f,d),this._collectLights(pc.LIGHTTYPE_SPOT,g[pc.LIGHTTYPE_SPOT],u,f,d)),b.lights=u):b.lights=[];e||(b.aoMapUv=b.aoMapUv||
...
this.mesh.vertexBuffer.format.size;var p,q,t,x,y;for(f=0;f<g.length;f++)g[f].name===pc.SEMANTIC_POSITION?q=g[f].offset:g[f].name===pc.SEMANTIC_BLENDINDICES?t=g[f].offset:g[f].name===pc.SEMANTIC_BLENDWEIGHT&&(x=g[f].offset);var g=new Uint8Array(this.mesh.vertexBuffer.storage),w=new Float32Array(this.mesh.vertexBuffer.storage),u=q/4,v=x/4,B=a/4,A,C,z,F,I;x=[];q=[];d=this.mesh.boneUsed;for(f=0;f<c;f++)x[f]=new pc.Vec3(Number.MAX_VALUE,Number.MAX_VALUE,Number.MAX_VALUE),q[f]=new pc.Vec3(-Number.MAX_VALUE,
-Number.MAX_VALUE,-Number.MAX_VALUE);for(y=0;y<e;y++)for(f=0;4>f;f++)0<w[y*B+v+f]&&(p=g[y*a+t+f],z=w[y*B+u],F=w[y*B+u+1],I=w[y*B+u+2],A=q[p],C=x[p],C.x>z&&(C.x=z),C.y>F&&(C.y=F),C.z>I&&(C.z=I),A.x<z&&(A.x=z),A.y<F&&(A.y=F),A.z<I&&(A.z=I),d[p]=!0);if(this.morphInstance){var G;d=this.morphInstance.morph._targets;var H=new Float32Array(3*e),D=new Float32Array(3*e),E;for(y=0;y<e;y++)H[3*y]=D[3*y]=w[y*B+u],H[3*y+1]=D[3*y+1]=w[y*B+u+1],H[3*y+2]=D[3*y+2]=w[y*B+u+2];for(e=0;e<d.length;e++)for(f=d[e],u=f.indices,
y=u.length,z=f.deltaPositions,f=0;f<y;f++)G=u[f],p=z[3*f],A=z[3*f+1],C=z[3*f+2],0>p?H[3*G]+=p:D[3*G]+=p,0>A?H[3*G+1]+=A:D[3*G+1]+=A,0>C?H[3*G+2]+=C:D[3*G+2]+=C;for(e=0;e<d.length;e++)for(f=d[e],u=f.indices,y=u.length,f=0;f<y;f++)for(G=u[f],E=0;4>E;E++)0<w[G*B+v+E]&&(p=g[G*a+t+E],A=q[p],C=x[p],z=H[3*G],F=H[3*G+1],I=H[3*G+2],C.x>z&&(C.x=z),C.y>F&&(C.y=F),C.z>I&&(C.z=I),z=D[3*G],F=D[3*G+1],I=D[3*G+2],A.x<z&&(A.x=z),A.y<F&&(A.y=F),A.z<I&&(A.z=I))}for(f=0;f<c;f++)a=new pc.BoundingBox,a.setMinMax(x[f],
...
return-1}};return{partitionSkin:function(d,f,g){var h,k,m,n;b(d);var l=d.vertices,r=d.skins,p,q=d.meshes,t=d.meshInstances,x=function(a){var b=new e;b.index=a;return b};for(h=r.length-1;0<=h;h--)if(r[h].boneNames.length>g){var y=r.splice(h,1)[0],w=[];for(k=0;k<q.length;k++)q[k].skin===y&&w.push(q[k]);for(k=0;k<w.length;k++)n=q.indexOf(w[k]),-1!==n&&q.splice(n,1);if(0===w.length)throw Error("partitionSkin: There should be at least one mesh that references a skin");var u=w[0].vertices;for(k=1;k<w.length;k++)if(w[k].vertices!==
u)throw Error("partitionSkin: All meshes that share a skin should also share the same vertex buffer");var v=[],B=[];m=[];var A=0;for(k=0;k<w.length;k++){p=w[k];for(var C=p.indices,z=p.base;z<p.base+p.count;){n=C[z++];B[0]=x(n);m[0]=n;n=C[z++];B[1]=x(n);m[1]=n;n=C[z++];B[2]=x(n);m[2]=n;for(var F=!1,I=A;I<v.length;I++)if(n=v[I],n.addPrimitive(B,m,u,g)){F=!0;break}F||(n=new a,n.originalMesh=p,n.addPrimitive(B,m,u,g),v.push(n))}A=v.length}p=[];w=[];for(k=0;k<v.length;k++)if(n=v[k],n.vertices.length&&
n.indices.length){B=p.length;m=n.vertices.length;A=w.length;C=n.indices.length;n.partition=k;n.vertexStart=B;n.vertexCount=m;n.indexStart=A;n.indexCount=C;z=0;for(F=B;z<m;)p[F++]=n.vertices[z++];z=0;for(F=A;z<C;)w[F++]=n.indices[z++]+B}B=[];for(k=0;k<v.length;k++){n=v[k];A=[];C=[];for(m=0;m<n.boneIndices.length;m++)A.push(y.inverseBindMatrices[n.boneIndices[m]]),C.push(y.boneNames[n.boneIndices[m]]);n={inverseBindMatrices:A,boneNames:C};B.push(n);r.push(n)}var G,y={};for(G in u)y[G]={components:u[G].components,
data:[],type:u[G].type};for(G in u)if("blendIndices"===G)for(n=y[G].data,k=0;k<p.length;k++)m=p[k].boneIndices,n.push(m[0],m[1],m[2],m[3]);else for(k=u[G],A=k.data,C=k.components,k=0;k<p.length;k++)for(n=p[k].index,m=0;m<C;m++)y[G].data.push(A[n*C+m]);l[l.indexOf(u)]=y;for(k=0;k<v.length;k++)for(n=v[k],p={aabb:{min:[0,0,0],max:[0,0,0]},vertices:y,skin:B[k],indices:w.splice(0,n.indexCount),type:"triangles",base:0,count:n.indexCount},q.push(p),m=t.length-1;0<=m;m--)t[m].mesh===n.originalMesh&&(t.push({mesh:p,
...
m=0;m<d.length;m++)d[m].name===pc.SEMANTIC_POSITION?a=d[m].offset:d[m].name===pc.SEMANTIC_NORMAL?b=d[m].offset:d[m].name===pc.SEMANTIC_TANGENT&&(c=d[m].offset);this._offsetPF=a/4;this._offsetNF=b/4;this._offsetTF=c/4;this._vertSizeF=e/4;this._dirty=!0},_calculateAabb:function(){if(this._baseBuffer){this.aabb.copy(this._baseAabb);var b,c,g,h,k,m,n,l=this._vertSizeF,r=this._offsetPF,p=this._baseData;for(c=0;c<this._targets.length;c++){h=this._targets[c];if(!h.aabb&&0<h.indices.length){h.aabb=this.aabb.clone();
e.set(Number.MAX_VALUE,Number.MAX_VALUE,Number.MAX_VALUE);a.set(-Number.MAX_VALUE,-Number.MAX_VALUE,-Number.MAX_VALUE);b=h.indices.length;for(g=0;g<b;g++)k=h.indices[g],m=k*l+r,k=p[m]+h.deltaPositions[3*g],n=p[m+1]+h.deltaPositions[3*g+1],m=p[m+2]+h.deltaPositions[3*g+2],e.x>k&&(e.x=k),e.y>n&&(e.y=n),e.z>m&&(e.z=m),a.x<k&&(a.x=k),a.y<n&&(a.y=n),a.z<m&&(a.z=m);h.aabb.setMinMax(e,a)}h.aabb&&this.aabb.add(h.aabb)}this._aabbDirty=!1}},addTarget:function(a){this._targets.push(a);this._aabbDirty=!0},removeTarget:function(a){a=
...
update:function(a){this.morph._baseBuffer!==a.vertexBuffer&&this.morph._setBaseMesh(a);this._vertexData||this._setBaseMesh(a);var b,c=this.morph._targets,d=this._weights,e,m,n,l,r,p=this.morph._vertSizeF,q=this.morph._offsetPF,t=this.morph._offsetNF,x=this.morph._offsetTF,y=this._vertexData;y.set(this.morph._baseData);for(var w=0;w<c.length;w++)if(m=d[w],0!==m)for(e=c[w],a=e.indices.length,n=0;n<a;n++)r=3*n,b=e.indices[n],l=b*p+q,y[l]+=e.deltaPositions[r]*m,y[l+1]+=e.deltaPositions[r+1]*m,y[l+2]+=
e.deltaPositions[r+2]*m,e.deltaNormals&&(l=b*p+t,y[l]+=e.deltaNormals[r]*m,y[l+1]+=e.deltaNormals[r+1]*m,y[l+2]+=e.deltaNormals[r+2]*m,e.deltaTangents&&(r=4*n,l=b*p+x,y[l]+=e.deltaTangents[r]*m,y[l+1]+=e.deltaTangents[r+1]*m,y[l+2]+=e.deltaTangents[r+2]*m,y[l+3]+=e.deltaTangents[r+3]*m,y[l+3]=0<y[l+3]?1:-1));this._vertexBuffer.unlock()}};return{MorphTarget:function(a){if(a.indices)this.indices=a.indices;else{var b=a.deltaPositions;this.indices=[];this.indices.length=b.length;for(var c=0;c<b.length;c++)this.indices[c]=
...
m=[0,0,0,0],l=[0,0,0,0],n=[0,0,0,0],p,q,r,t,x,u;for(p=0;p<this.precision+1;p++){r=Math.min(p,this.precision-1);for(q=0;4>q;q++)t=k[q][3*r]*h+m[q],x=k[q][3*r+1]*h+l[q],u=k[q][3*r+2]*h+n[q],a>t&&(a=t),b>x&&(b=x),c>u&&(c=u),d<t&&(d=t),f<x&&(f=x),g<u&&(g=u),m[q]=t,l[q]=x,n[q]=u;e=Math.max(e,this.qScale[r])}this.emitterShape===pc.EMITTERSHAPE_BOX?(t=.5*this.emitterExtents.x,x=.5*this.emitterExtents.y,u=.5*this.emitterExtents.z):u=x=t=this.emitterRadius;d<t&&(d=t);f<x&&(f=x);g<u&&(g=u);t=-t;x=-x;u=-u;a>
t&&(a=t);b>x&&(b=x);c>u&&(c=u);J.x=a-e;J.y=b-e;J.z=c-e;Z.x=d+e;Z.y=f+e;Z.z=g+e;this.localBounds.setMinMax(J,Z)},rebuild:function(){var a,b=this.graphicsDevice;null===this.colorMap&&(this.colorMap=Q.DEFAULT_PARAM_TEXTURE);this.spawnBounds=this.emitterShape===pc.EMITTERSHAPE_BOX?this.emitterExtents:this.emitterRadius;this.useCpu=this.useCpu||this.sort>pc.PARTICLESORT_NONE||1>=b.maxVertexTextures||64>b.fragmentUniformsCount||b.forceCpuParticles||!b.extTextureFloat;this.vertexBuffer=void 0;this.pack8=
...
h(f,a,1,b(this.qVelocity,this.qVelocityDiv));g=this.qRotSpeed;for(var m=this.qScale,l=this.qScaleDiv,e=this.qRotSpeedDiv,k=this.qAlphaDiv,n=Array(4*g.length),p=0;p<g.length;p++)n[4*p]=g[p],n[4*p+1]=m[p],n[4*p+2]=0,n[4*p+3]=(255*l[p]<<16|255*e[p]<<8|255*k[p])/16777216;this.internalTex2=h(f,a,1,n)}g=this.qColor;m=this.qAlpha;l=Array(4*m.length);for(e=0;e<m.length;e++)l[4*e]=g[3*e],l[4*e+1]=g[3*e+1],l[4*e+2]=g[3*e+2],l[4*e+3]=m[e];this.internalTex3=h(f,a,1,l,pc.PIXELFORMAT_R8_G8_B8_A8,1,!0)},_initializeTextures:function(){this.colorMap&&
...
this.material.setParameter("emitterScale",k);this.localSpace&&this.meshInstance.node&&this.material.setParameter("emitterPos",this.meshInstance.node.getPosition().data);if(this.useCpu){k=new Float32Array(this.vertexBuffer.lock());if(this.meshInstance.node){h=this.meshInstance.node.worldTransform;for(m=0;12>m;m++)A.data[m]=h.data[m];I=this.meshInstance.node.localScale;F=Math.max(Math.max(I.x,I.y),I.z)}m=null===this.meshInstance.node||this.localSpace?pc.Vec3.ZERO:this.meshInstance.node.getPosition();
var l=this.camera?this.camera._node.getPosition():pc.Vec3.ZERO,n,r,D,J,Z,Y,W,Q=this.precision-1;for(h=0;h<this.numParticles;h++){var O=Math.floor(this.vbCPU[h*this.numParticleVerts*4+3]),T=this.particleTex[4*O+0+8*this.numParticlesPot];y.data[0]=T;y.data[1]=this.particleTex[4*O+1+8*this.numParticlesPot];y.data[2]=this.particleTex[4*O+2+8*this.numParticlesPot];var ha=this.rate+(this.rate2-this.rate)*T,ia=this.lifetime,X=this.particleTex[4*O+3+4*this.numParticlesPot]+a,ma=Math.max(Math.min(X/ia,1),
0),ja=0;c=0;var la=0<X&&X<ia;la?(g=ma*Q,n=Math.floor(g),r=Math.ceil(g),g%=1,c=this.qRotSpeed[n],d=this.qRotSpeed[r],D=c+(d-c)*g,c=this.qRotSpeed2[n],d=this.qRotSpeed2[r],J=c+(d-c)*g,c=this.qScale[n],d=this.qScale[r],ja=c+(d-c)*g,c=this.qScale2[n],d=this.qScale2[r],Z=c+(d-c)*g,c=this.qAlpha[n],d=this.qAlpha[r],Y=c+(d-c)*g,c=this.qAlpha2[n],d=this.qAlpha2[r],W=c+(d-c)*g,n*=3,r*=3,c=this.qLocalVelocity[n],d=this.qLocalVelocity[r],q.data[0]=c+(d-c)*g,c=this.qLocalVelocity[n+1],d=this.qLocalVelocity[r+
...
p.data[0]+=(t.data[0]-p.data[0])*y.data[0],p.data[1]+=(t.data[1]-p.data[1])*y.data[1],p.data[2]+=(t.data[2]-p.data[2])*y.data[2],D+=(J-D)*y.data[1],ja=(ja+1E4*T%1*(Z-ja))*F,c=1E3*T%1*(W-Y),this.meshInstance.node&&A.transformPoint(q,q),q.add(p.mul(I)),B.copy(q),w.data[0]=this.particleTex[4*O],w.data[1]=this.particleTex[4*O+1],w.data[2]=this.particleTex[4*O+2],u.copy(w).add(q.scale(a)),v.copy(u),this.particleTex[4*O]=v.data[0],this.particleTex[4*O+1]=v.data[1],this.particleTex[4*O+2]=v.data[2],this.particleTex[4*
O+3]+=D*a,this.wrap&&this.wrapBounds&&(v.sub(m),v.data[0]=e(v.data[0],this.wrapBounds.data[0])-.5*this.wrapBounds.data[0],v.data[1]=e(v.data[1],this.wrapBounds.data[1])-.5*this.wrapBounds.data[1],v.data[2]=e(v.data[2],this.wrapBounds.data[2])-.5*this.wrapBounds.data[2],v.add(m)),0<this.sort&&(1===this.sort?(E.copy(v).sub(l),this.particleDistance[O]=-(E.data[0]*E.data[0]+E.data[1]*E.data[1]+E.data[2]*E.data[2])):2===this.sort?this.particleDistance[O]=X:3===this.sort&&(this.particleDistance[O]=-X))):
this.calcSpawnPosition(m,O);b?0>X&&(this.particleTex[4*O+3+8*this.numParticlesPot]=-1):(X>=ia&&(X-=Math.max(ia,(this.numParticles-1)*ha),this.particleTex[4*O+3+8*this.numParticlesPot]=this.loop?1:-1),0>X&&this.loop&&(this.particleTex[4*O+3+8*this.numParticlesPot]=1));0>this.particleTex[4*O+3+8*this.numParticlesPot]&&(la=!1);this.particleTex[4*O+3+4*this.numParticlesPot]=X;for(D=0;D<this.numParticleVerts;D++)T=this.vbCPU[h*this.numParticleVerts*4+4*D],ha=this.vbCPU[h*this.numParticleVerts*4+4*D+1],
ia=this.vbCPU[h*this.numParticleVerts*4+4*D+2],la||(T=ha=ia=0),X=h*this.numParticleVerts*14+14*D,k[X]=v.data[0],k[X+1]=v.data[1],k[X+2]=v.data[2],k[X+3]=ma,k[X+4]=this.alignToMotion?0:this.particleTex[4*O+3],k[X+5]=ja,k[X+6]=c,k[X+7]=B.data[0],k[X+8]=T,k[X+9]=ha,k[X+10]=ia,k[X+11]=B.data[1],k[X+12]=B.data[2]}if(this.sort>pc.PARTICLESORT_NONE&&this.camera){m=this.particleDistance;for(h=0;h<this.numParticles;h++)this.vbToSort[h]=[h,m[Math.floor(this.vbCPU[h*this.numParticleVerts*4+3])]];this.vbOld.set(this.vbCPU);
this.vbToSort.sort(function(a,b){return a[1]-b[1]});for(h=0;h<this.numParticles;h++)for(k=this.vbToSort[h][0]*this.numParticleVerts*4,l=h*this.numParticleVerts*4,m=0;m<4*this.numParticleVerts;m++)this.vbCPU[l+m]=this.vbOld[k+m]}}else h.setBlending(!1),h.setColorWrite(!0,!0,!0,!0),h.setCullMode(pc.CULLFACE_NONE),h.setDepthTest(!1),h.setDepthWrite(!1),this.frameRandom.x=Math.random(),this.frameRandom.y=Math.random(),this.frameRandom.z=Math.random(),this.constantGraphSampleSize.setValue(1/this.precision),
...
for(var m,n,b=0;b<d*f;b++)e=k[4*b+0],m=k[4*b+1],n=k[4*b+2],e=e<<16|m<<8|n,16777215!==e&&(e=c[e],-1===a.indexOf(e)&&a.push(e));return a};a.prototype.prepare=function(a,c,d){var b=this.device,g,e=this;a instanceof pc.Camera&&(a=a._component);this.scene=c;var k=null,m=null;d instanceof pc.Layer?k=d:m=d;if(!this.layer){var n=b.scope.resolve("uColor");this.layer=new pc.Layer({name:"Picker",shaderPass:pc.SHADER_PICK,opaqueSortMode:pc.SORTMODE_NONE,onEnable:function(){if(!this.renderTarget){var a=new pc.Texture(b,
...
pc.calculateNormals=function(e,a){var b=a.length/3,c=e.length/3,d,f,g,h,k=new pc.Vec3,m=new pc.Vec3,n=new pc.Vec3,l=new pc.Vec3,r=new pc.Vec3,p=new pc.Vec3,q=[];for(h=0;h<e.length;h++)q[h]=0;for(h=0;h<b;h++)d=a[3*h],f=a[3*h+1],g=a[3*h+2],k.set(e[3*d],e[3*d+1],e[3*d+2]),m.set(e[3*f],e[3*f+1],e[3*f+2]),n.set(e[3*g],e[3*g+1],e[3*g+2]),l.sub2(m,k),r.sub2(n,k),p.cross(l,r).normalize(),q[3*d]+=p.x,q[3*d+1]+=p.y,q[3*d+2]+=p.z,q[3*f]+=p.x,q[3*f+1]+=p.y,q[3*f+2]+=p.z,q[3*g]+=p.x,q[3*g+1]+=p.y,q[3*g+2]+=p.z;
for(h=0;h<c;h++)b=q[3*h],d=q[3*h+1],f=q[3*h+2],b=1/Math.sqrt(b*b+d*d+f*f),q[3*h]*=b,q[3*h+1]*=b,q[3*h+2]*=b;return q};
pc.calculateTangents=function(e,a,b,c){var d=c.length/3,f=e.length/3,g,h,k,m,n,l,r,p,q,t,x,y,w,u,v=new pc.Vec3,B=new pc.Vec3,A=new pc.Vec3,C=new pc.Vec3,z=new pc.Vec3,F=new pc.Vec2,I=new pc.Vec2,G=new pc.Vec2,H,D=new Float32Array(3*f),E=new Float32Array(3*f),J=[];for(H=0;H<d;H++)g=c[3*H],h=c[3*H+1],k=c[3*H+2],A.set(e[3*g],e[3*g+1],e[3*g+2]),C.set(e[3*h],e[3*h+1],e[3*h+2]),z.set(e[3*k],e[3*k+1],e[3*k+2]),F.set(b[2*g],b[2*g+1]),I.set(b[2*h],b[2*h+1]),G.set(b[2*k],b[2*k+1]),m=C.x-A.x,n=z.x-A.x,l=C.y-
A.y,r=z.y-A.y,p=C.z-A.z,q=z.z-A.z,t=I.x-F.x,x=G.x-F.x,y=I.y-F.y,w=G.y-F.y,u=t*w-x*y,0==u?(v.set(0,1,0),B.set(1,0,0)):(u=1/u,v.set((w*m-y*n)*u,(w*l-y*r)*u,(w*p-y*q)*u),B.set((t*n-x*m)*u,(t*r-x*l)*u,(t*q-x*p)*u)),D[3*g+0]+=v.x,D[3*g+1]+=v.y,D[3*g+2]+=v.z,D[3*h+0]+=v.x,D[3*h+1]+=v.y,D[3*h+2]+=v.z,D[3*k+0]+=v.x,D[3*k+1]+=v.y,D[3*k+2]+=v.z,E[3*g+0]+=B.x,E[3*g+1]+=B.y,E[3*g+2]+=B.z,E[3*h+0]+=B.x,E[3*h+1]+=B.y,E[3*h+2]+=B.z,E[3*k+0]+=B.x,E[3*k+1]+=B.y,E[3*k+2]+=B.z;y=new pc.Vec3;w=new pc.Vec3;e=new pc.Vec3;
b=new pc.Vec3;for(H=0;H<f;H++)e.set(a[3*H],a[3*H+1],a[3*H+2]),y.set(D[3*H],D[3*H+1],D[3*H+2]),w.set(E[3*H],E[3*H+1],E[3*H+2]),c=e.dot(y),b.copy(e).scale(c),b.sub2(y,b).normalize(),J[4*H]=b.x,J[4*H+1]=b.y,J[4*H+2]=b.z,b.cross(e,y),J[4*H+3]=0>b.dot(w)?-1:1;return J};
...
var l=new pc.VertexFormat(e,b);b=a.length/3;for(var l=new pc.VertexBuffer(e,l,b),r=new pc.VertexIterator(l),p=0;p<b;p++)r.element[pc.SEMANTIC_POSITION].set(a[3*p],a[3*p+1],a[3*p+2]),null!==c&&r.element[pc.SEMANTIC_NORMAL].set(c[3*p],c[3*p+1],c[3*p+2]),null!==d&&r.element[pc.SEMANTIC_TANGENT].set(d[4*p],d[4*p+1],d[4*p+2],d[4*p+3]),null!==f&&r.element[pc.SEMANTIC_COLOR].set(f[4*p],f[4*p+1],f[4*p+2],f[4*p+3]),null!==g&&r.element[pc.SEMANTIC_TEXCOORD0].set(g[2*p],g[2*p+1]),null!==h&&r.element[pc.SEMANTIC_TEXCOORD1].set(h[2*
p],h[2*p+1]),null!==m&&r.element[pc.SEMANTIC_BLENDINDICES].set(m[2*p],m[2*p+1]),null!==n&&r.element[pc.SEMANTIC_BLENDWEIGHT].set(n[2*p],n[2*p+1]),r.next();r.end();c=null;if(d=null!==k)c=new pc.IndexBuffer(e,pc.INDEXFORMAT_UINT16,k.length),(new Uint16Array(c.lock())).set(k),c.unlock();e=new pc.BoundingBox;e.compute(a);a=new pc.Mesh;a.vertexBuffer=l;a.indexBuffer[0]=c;a.primitive[0].type=pc.PRIMITIVE_TRIANGLES;a.primitive[0].base=0;a.primitive[0].count=d?k.length:b;a.primitive[0].indexed=d;a.aabb=e;
return a};
pc.createTorus=function(e,a){var b=a&&void 0!==a.tubeRadius?a.tubeRadius:.2,c=a&&void 0!==a.ringRadius?a.ringRadius:.3,d=a&&void 0!==a.segments?a.segments:30,f=a&&void 0!==a.sides?a.sides:20,g,h,k,m,n,l,r,p,q,t,x=[],y=[],w=[],u=[];for(g=0;g<=f;g++)for(h=0;h<=d;h++)k=Math.cos(2*Math.PI*h/d)*(c+b*Math.cos(2*Math.PI*g/f)),m=Math.sin(2*Math.PI*g/f)*b,n=Math.sin(2*Math.PI*h/d)*(c+b*Math.cos(2*Math.PI*g/f)),l=Math.cos(2*Math.PI*h/d)*Math.cos(2*Math.PI*g/f),r=Math.sin(2*Math.PI*g/f),p=Math.sin(2*Math.PI*
h/d)*Math.cos(2*Math.PI*g/f),q=g/f,t=1-h/d,x.push(k,m,n),y.push(l,r,p),w.push(q,t),g<f&&h<d&&(k=g*(d+1)+h,m=(g+1)*(d+1)+h,n=g*(d+1)+(h+1),l=(g+1)*(d+1)+(h+1),u.push(k,m,n),u.push(m,l,n));b={normals:y,uvs:w,indices:u};pc.precalculatedTangents&&(b.tangents=pc.calculateTangents(x,y,w,u));return pc.createMesh(e,x,b)};
pc._createConeData=function(e,a,b,c,d,f){var g,h,k,m,n,l=new pc.Vec3,r=new pc.Vec3;k=new pc.Vec3;var p,q=[],t=[],x=[],y=[],w=[],u;if(0<b)for(g=0;g<=c;g++)for(h=0;h<=d;h++)u=h/d*2*Math.PI-Math.PI,p=Math.sin(u),u=Math.cos(u),n=new pc.Vec3(p*e,-b/2,u*e),m=new pc.Vec3(p*a,b/2,u*a),l.lerp(n,m,g/c),r.sub2(m,n).normalize(),p=new pc.Vec3(u,0,-p),k.cross(p,r).normalize(),q.push(l.x,l.y,l.z),t.push(k.x,k.y,k.z),m=h/d,n=g/c,x.push(m,n),p=n,n=m,m=p,m/=3,m=m*primitiveUv1PaddingScale+primitiveUv1Padding,n=n*primitiveUv1PaddingScale+
primitiveUv1Padding,y.push(m,n),g<c&&h<d&&(p=g*(d+1)+h,u=g*(d+1)+(h+1),m=(g+1)*(d+1)+h,n=(g+1)*(d+1)+(h+1),w.push(p,u,m),w.push(u,n,m));if(f){e=Math.floor(d/2);g=b/2;for(b=0;b<=e;b++)for(u=b*Math.PI*.5/e,p=Math.sin(u),u=Math.cos(u),l=0;l<=d;l++)f=2*l*Math.PI/d-Math.PI/2,m=Math.sin(f),f=Math.cos(f),f*=p,h=u,k=m*p,m=1-l/d,n=1-b/e,q.push(f*a,h*a+g,k*a),t.push(f,h,k),x.push(m,n),m/=3,n/=3,m=m*primitiveUv1PaddingScale+primitiveUv1Padding,n=n*primitiveUv1PaddingScale+primitiveUv1Padding,m+=1/3,y.push(m,
n);r=(c+1)*(d+1);for(b=0;b<e;++b)for(l=0;l<d;++l)p=b*(d+1)+l,u=p+d+1,w.push(r+p+1,r+u,r+p),w.push(r+p+1,r+u+1,r+u);for(b=0;b<=e;b++)for(u=.5*Math.PI+b*Math.PI*.5/e,p=Math.sin(u),u=Math.cos(u),l=0;l<=d;l++)f=2*l*Math.PI/d-Math.PI/2,m=Math.sin(f),f=Math.cos(f),f*=p,h=u,k=m*p,m=1-l/d,n=1-b/e,q.push(f*a,h*a-g,k*a),t.push(f,h,k),x.push(m,n),m/=3,n/=3,m=m*primitiveUv1PaddingScale+primitiveUv1Padding,n=n*primitiveUv1PaddingScale+primitiveUv1Padding,m+=2/3,y.push(m,n);r=(c+1)*(d+1)+(d+1)*(e+1);for(b=0;b<
e;++b)for(l=0;l<d;++l)p=b*(d+1)+l,u=p+d+1,w.push(r+p+1,r+u,r+p),w.push(r+p+1,r+u+1,r+u)}else{r=(c+1)*(d+1);if(0<e)for(g=0;g<d;g++)u=g/d*2*Math.PI,f=Math.sin(u),h=-b/2,k=Math.cos(u),m=1-(f+1)/2,n=(k+1)/2,q.push(f*e,h,k*e),t.push(0,-1,0),x.push(m,n),m/=3,n/=3,m=m*primitiveUv1PaddingScale+primitiveUv1Padding,n=n*primitiveUv1PaddingScale+primitiveUv1Padding,m+=1/3,y.push(m,n),1<g&&w.push(r,r+g,r+g-1);r+=d;if(0<a)for(g=0;g<d;g++)u=g/d*2*Math.PI,f=Math.sin(u),h=b/2,k=Math.cos(u),m=1-(f+1)/2,n=(k+1)/2,q.push(f*
a,h,k*a),t.push(0,1,0),x.push(m,n),m/=3,n/=3,m=m*primitiveUv1PaddingScale+primitiveUv1Padding,n=n*primitiveUv1PaddingScale+primitiveUv1Padding,m+=2/3,y.push(m,n),1<g&&w.push(r,r+g-1,r+g)}return{positions:q,normals:t,uvs:x,uvs1:y,indices:w}};
...
pc.createSphere=function(e,a){var b=a&&void 0!==a.radius?a.radius:.5,c=a&&void 0!==a.latitudeBands?a.latitudeBands:16,d=a&&void 0!==a.longitudeBands?a.longitudeBands:16,f,g,h,k,m,n,l,r,p,q=[],t=[],x=[],y=[];for(g=0;g<=c;g++)for(f=g*Math.PI/c,h=Math.sin(f),k=Math.cos(f),f=0;f<=d;f++)m=2*f*Math.PI/d-Math.PI/2,n=Math.sin(m),m=Math.cos(m),m*=h,l=k,n*=h,r=1-f/d,p=1-g/c,q.push(m*b,l*b,n*b),t.push(m,l,n),x.push(r,p);for(g=0;g<c;++g)for(f=0;f<d;++f)b=g*(d+1)+f,h=b+d+1,y.push(b+1,h,b),y.push(b+1,h+1,h);c=
...
pc.createPlane=function(e,a){var b=a&&void 0!==a.halfExtents?a.halfExtents:new pc.Vec2(.5,.5),c=a&&void 0!==a.widthSegments?a.widthSegments:5,d=a&&void 0!==a.lengthSegments?a.lengthSegments:5,f,g,h,k,m,n,l=[],r=[],p=[],q=[],t=0;for(f=0;f<=c;f++)for(g=0;g<=d;g++)h=-b.x+2*b.x*f/c,k=-(-b.y+2*b.y*g/d),m=f/c,n=g/d,l.push(h,0,k),r.push(0,1,0),p.push(m,n),f<c&&g<d&&(q.push(t+d+1,t+1,t),q.push(t+d+1,t+d+2,t+1)),t++;b={normals:r,uvs:p,uvs1:p,indices:q};pc.precalculatedTangents&&(b.tangents=pc.calculateTangents(l,
r,p,q));return pc.createMesh(e,l,b)};
...
(this._dirty=!0)};m.prototype.removeMeshInstances=function(a,b){var c,d,f,g,e,h,m,k=this.opaqueMeshInstances,l=this.transparentMeshInstances,n=this.shadowCasters;for(c=0;c<a.length;c++){f=a[c];g=-1;e=0;h=k.length;for(d=0;d<h;d++){m=k[d];if(m===f){g=d;e=1;break}if(m._staticSource===f)0>g&&(g=d),e++;else if(0<=g)break}0<=g&&k.splice(g,e);g=-1;e=0;h=l.length;for(d=0;d<h;d++){m=l[d];if(m===f){g=d;e=1;break}if(m._staticSource===f)0>g&&(g=d),e++;else if(0<=g)break}0<=g&&l.splice(g,e);b||(d=n.indexOf(f),
...
function(){var a=pc.Vec2.ONE,b,f,g,e,k,m,n=[],l=[],r=[],p=[],q=0;for(b=0;3>=b;b++)for(k=0===b||3===b?0:1,f=0;3>=f;f++)g=-a.x+2*a.x*(1>=b?0:3)/3,e=-(-a.y+2*a.y*(1>=f?0:3)/3),m=0===f||3===f?0:1,n.push(-g,0,e),l.push(0,1,0),r.push(k,m),3>b&&3>f&&(p.push(q+3+1,q+1,q),p.push(q+3+1,q+3+2,q+1)),q++;return pc.createMesh(this._device,n,{normals:l,uvs:r,indices:p})};b.prototype._onSetFrames=function(a){this._updatingProperties?this._meshesDirty=!0:this._createMeshes()};b.prototype._onFrameChanged=function(a,
...
!0;this.event.stopImmediatePropagation();this.event.stopPropagation()}};var p=function(a,b,c,d,f,g){this.x=c;this.y=d;this.ctrlKey=a.ctrlKey||!1;this.altKey=a.altKey||!1;this.shiftKey=a.shiftKey||!1;this.metaKey=a.metaKey||!1;this.button=a.button;pc.Mouse.isPointerLocked()?(this.dx=a.movementX||a.webkitMovementX||a.mozMovementX||0,this.dy=a.movementY||a.webkitMovementY||a.mozMovementY||0):(this.dx=c-f,this.dy=d-g);this.wheel=a.detail?-1*a.detail:a.wheelDelta?a.wheelDelta/120:0},p=pc.inherits(p,r),
q=function(a,b,c){this.touches=a.touches;this.changedTouches=a.changedTouches},q=pc.inherits(q,r),t=function(a){this._app=null;this._attached=!1;this._target=null;this._lastY=this._lastX=0;this._upHandler=this._handleUp.bind(this);this._downHandler=this._handleDown.bind(this);this._moveHandler=this._handleMove.bind(this);this._wheelHandler=this._handleWheel.bind(this);this._touchstartHandler=this._handleTouchStart.bind(this);this._touchcancelHandler=this._touchendHandler=this._handleTouchEnd.bind(this);
...
e=new a(d.length),k=!1,m=function(){c.graphicsDevice&&!k&&e.done()&&(k=!0,c.fire("preload:end"),b())},n=d.length,l;if(e.length){var r=function(a){e.inc();c.fire("preload:progress",e.count/n);e.done()&&m()},p=function(a,b){e.inc();c.fire("preload:progress",e.count/n);e.done()&&m()};for(l=0;l<d.length;l++)d[l].loaded?(e.inc(),c.fire("preload:progress",e.count/n),e.done()&&m()):(d[l].once("load",r),d[l].once("error",p),this.assets.load(d[l]))}else m()},loadSceneHierarchy:function(a,b){var c=this,d=this.loader.getHandler("hierarchy");
...
this;this.layer.shader=m.shader;this.layer.renderTarget=m.destRenderTarget;if(!b){b=n.scope.resolve("uColorBuffer");c=n.scope.resolve("uScreenSize");for(var G=n.supportsMsaa?4:1,I=0;2>I;I++)a[I]=new pc.RenderTarget({depth:!0,stencil:n.supportsStencil,samples:G,autoResolve:!1}),a[I].name="backbuffer"+I;e.on("prerender",function(){var b=e.scene.layers.layerList,c,d,m=0,l=0;k=h=g=!1;var D=pc.PIXELFORMAT_R8_G8_B8_A8;if(e.scene.layers._dirty){var G=0,E,H;for(c=0;c<b.length;c++){d=!1;var I;if((I=b[c].isPostEffect)&&
!(I=0===G)&&(I=b[c].unmodifiedUvs&&b[c].shader)){a:{var J,N,P,ba;E=b;H=f;var M=G,V=F(b[c].shader.definition.fshader);if(0!==V.length)for(ba=0;ba<M;ba++)for(P=0;P<V.length;P++)for(I=V[P],J=F(E[H[ba]].shader.definition.fshader),N=0;N<J.length;N++)if(J[N]===I){I=!0;break a}I=!1}I=!I}I?(f[G]=c,G++,c===b.length-1&&(d=!0)):0<G&&(d=!0);if(d){if(1<G){I="post_";for(d=0;d<G;d++)J=b[f[d]],I+=J.name?J.name:J.id,d<G-1&&(I+="_");J=n.programLib._cache[I];if(!J){N="vec4 shaderOutput;\n";P="void main() {\n";ba=[];
for(d=0;d<G;d++){J=b[f[d]].shader.definition.fshader+"\n";J=J.replace(x,"//").replace(y,"//").replace(w,"//").replace(u,"shaderOutput");0<d&&(J=J.replace(v,"//").replace(B,"//").replace(A,"shaderOutput;//"));J=J.replace(C,"void main"+d);var L,fa,ga,V=J;H=ba;fa=V.length;var ca=0,da=L=0,M="";for(E=0;E<fa;E++)ga=V.charAt(E),"{"===ga?(0===L&&(ca=E),L++):"}"===ga&&(1===L&&(ga=E,M+=V.substr(da,ca-da+1),da=ga),L--);M+=V.substr(da,V.length-da+1);ca=null;da=M.match(r)||[];for(E=0;E<da.length;E++)for(V=da[E].split(","),
fa=0;fa<V.length;fa++)L=V[fa].replace(p,"").trim(),0<=H.indexOf(L)?(ca||(ca=[]),ca.push(L)):H.push(L);M=M.match(q)||[];for(E=0;E<M.length;E++)for(V=M[E].split(","),fa=0;fa<V.length;fa++)L=V[fa].replace(t,"").trim(),L=H.indexOf(L),0<=L&&H.splice(L,1);if(E=ca)for(H=0;H<E.length;H++)J=J.replace(new RegExp("\\b"+E[H]+"\\b","g"),E[H]+"NNNN"+d);N+=J;P+="main"+d+"();\n"}P+="gl_FragColor = shaderOutput;\n}\n";J=pc.shaderChunks.createShaderFromCode(n,pc.shaderChunks.fullscreenQuadVS,N+P,I)}for(d=0;d<G;d++)b[f[d]]._postEffectCombined=
d===G-1?1:-1;b[f[G-1]]._postEffectCombinedShader=J;b[f[G-1]]._postEffectCombinedBilinear=b[f[0]].postEffectBilinear;b[f[G-1]]._postEffectCombinedSrc=b[f[0]].postEffect.srcRenderTarget}f[0]=c;G=1}}}for(c=0;c<b.length;c++){if(b[c].isPostEffect&&(!b[c].postEffect.srcRenderTarget&&!b[c]._postEffectCombined||!b[c].postEffect._postEffectCombinedSrc&&0<=b[c]._postEffectCombined)){for(d=c-1;d>=m;d--)b[d].renderTarget||(b[d].renderTarget=a[l]);b[c]._backbufferRtId=l;m=c;g=!0;1===l&&(h=!0);b[c].postEffect.hdr&&
(D=n.webgl2&&n.extTextureFloatRenderable?pc.PIXELFORMAT_111110F:n.extTextureHalfFloatLinear&&n.extTextureHalfFloatRenderable?pc.PIXELFORMAT_RGBA16F:pc.PIXELFORMAT_R8_G8_B8_A8);b[c].postEffect.shader&&!b[c].renderTarget&&(l=1-l)}else b[c].isPostEffect||b[c].renderTarget||!g||(b[c].renderTarget=a[l]);b[c].isPostEffect&&!b[c].renderTarget&&(k=!0)}if(g)if(!a[0].colorBuffer)z(0,n,D);else if(a[0].width!==n.width||a[0].height!==n.height||a[0]._colorBuffer._format!==D)a[0].colorBuffer.destroy(),a[0].destroy(),
z(0,n,D);if(h)if(!a[1].colorBuffer)z(1,n,D);else if(a[1].width!==n.width||a[1].height!==n.height||a[1]._colorBuffer._format!==D)a[1].colorBuffer.destroy(),a[1].destroy(),z(1,n,D)},this);e.on("postrender",function(){var b=e.graphicsDevice;if(g&&!k){for(var c=e.scene.layers.layerList,d,f=c.length-1;0<=f&&(d=c[f].renderTarget,d!==a[0]&&d!==a[1]);f--);d&&(1<d._samples&&d.resolve(!0,!1),b.copyRenderTarget(d,null,!0,!1))}},this)}}var a=[null,null],b=null,c,d=new pc.Vec4,f=[],g=!1,h=!1,k=!1,m=/uniform[ \t\n\r]+\S+[ \t\n\r]+\S+[ \t\n\r]*\;/g,
...
B=/(varying|in)[ \t\n\r]+vec2[ \t\n\r]+vUv0;/g,A=/(texture2D|texture)[ \t\n\r]*\([ \t\n\r]*uColorBuffer/g,C=/void[ \t\n\r]+main/g,z=function(b,c,d){c=new pc.Texture(c,{format:d,width:c.width,height:c.height});c.minFilter=pc.FILTER_NEAREST;c.magFilter=pc.FILTER_NEAREST;c.addressU=pc.ADDRESS_CLAMP_TO_EDGE;c.addressV=pc.ADDRESS_CLAMP_TO_EDGE;a[b]._colorBuffer=c},F=function(a){a=a.match(m)||[];for(var b,c,d=[],f=0;f<a.length;f++)b=a[f].search(n),c=a[f].search(l),b=a[f].substr(b,c-b),"uColorBuffer"!==
...
r&&(r.activate(),a.setValue(c,f,e),void 0!==m?(b.setValue(m,n,l),r.applyForce(a,b)):r.applyForce(a,d))},applyTorque:function(){var b,c,d;switch(arguments.length){case 1:b=arguments[0].x;c=arguments[0].y;d=arguments[0].z;break;case 3:b=arguments[0];c=arguments[1];d=arguments[2];break;default:return}var f=this.body;f&&(f.activate(),a.setValue(b,c,d),f.applyTorque(a))},applyImpulse:function(){var c,f,e,m,n,l;switch(arguments.length){case 1:c=arguments[0].x;f=arguments[0].y;e=arguments[0].z;break;case 2:c=
arguments[0].x;f=arguments[0].y;e=arguments[0].z;m=arguments[1].x;n=arguments[1].y;l=arguments[1].z;break;case 3:c=arguments[0];f=arguments[1];e=arguments[2];break;case 6:c=arguments[0];f=arguments[1];e=arguments[2];m=arguments[3];n=arguments[4];l=arguments[5];break;default:return}var r=this.body;r&&(r.activate(),a.setValue(c,f,e),void 0!==m?(b.setValue(m,n,l),r.applyImpulse(a,b)):r.applyImpulse(a,d))},applyTorqueImpulse:function(){var b,c,d;switch(arguments.length){case 1:b=arguments[0].x;c=arguments[0].y;
...
b[a].entity,f=d.collision,e=b[a].others,g=e.length;g--;){var h=e[g];if(!c[a]||0>c[a].others.indexOf(h))e.splice(g,1),f&&h.collision&&(d.rigidbody&&h.rigidbody?f.fire("collisionend",h):d.trigger&&f.fire("triggerleave",h))}0===e.length&&delete b[a]}},onUpdate:function(a){this.dynamicsWorld.stepSimulation(a,this.maxSubSteps,this.fixedTimeStep);var b=this.store,d;for(d in b)if(b.hasOwnProperty(d)){var f=b[d].entity,e=b[d].data;e.body&&e.body.isActive()&&e.enabled&&f.enabled&&(e.type===pc.BODYTYPE_DYNAMIC?
f.rigidbody.syncBodyToEntity():e.type===pc.BODYTYPE_KINEMATIC&&f.rigidbody._updateKinematic(a))}a=this.dynamicsWorld.getDispatcher();var b=a.getNumManifolds(),g;c={};for(d=0;d<b;d++){var h=a.getManifoldByIndexInternal(d),m=h.getBody0(),k=h.getBody1(),f=Ammo.castObject(m,Ammo.btRigidBody),e=Ammo.castObject(k,Ammo.btRigidBody),f=f.entity,e=e.entity;if(f&&e){g=m.getCollisionFlags();var l=k.getCollisionFlags(),n=h.getNumContacts(),A=[],k=[],C;if(0<n)if(g&pc.BODYFLAG_NORESPONSE_OBJECT||l&pc.BODYFLAG_NORESPONSE_OBJECT)C=
f.collision?f.collision.hasEvent("triggerenter")||f.collision.hasEvent("triggerleave"):!1,m=e.collision?e.collision.hasEvent("triggerenter")||e.collision.hasEvent("triggerleave"):!1,C&&(h=this._storeCollision(f,e))&&(!f.collision||l&pc.BODYFLAG_NORESPONSE_OBJECT||f.collision.fire("triggerenter",e)),m&&(h=this._storeCollision(e,f))&&(!e.collision||g&pc.BODYFLAG_NORESPONSE_OBJECT||e.collision.fire("triggerenter",f));else if(C=f.collision?f.collision.hasEvent("collisionstart")||f.collision.hasEvent("collisionend")||
f.collision.hasEvent("contact"):!1,m=e.collision?e.collision.hasEvent("collisionstart")||e.collision.hasEvent("collisionend")||e.collision.hasEvent("contact"):!1,(l=this.hasEvent("contact"))||C||m){for(g=0;g<n;g++){var z=h.getContactPoint(g),F=this._createContactPointFromAmmo(z);if(C||m)z=this._createReverseContactPointFromAmmo(z),A.push(F),k.push(z);l&&(F=this._createSingleContactResult(f,e,F),this.fire("contact",F))}C&&(n=this._createContactResult(e,A),f.collision&&f.collision.fire("contact",n),
...
f,f);c=new Ammo.btCylinderShapeX(c);break;case 1:c=new Ammo.btVector3(f,.5*e,f);c=new Ammo.btCylinderShape(c);break;case 2:c=new Ammo.btVector3(f,f,.5*e),c=new Ammo.btCylinderShapeZ(c)}return c}});var g=function(a){},g=pc.inherits(g,a);g.prototype=pc.extend(g.prototype,{beforeInitialize:function(a,b){},createPhysicalShape:function(a,b){if("undefined"!==typeof Ammo&&b.model){var c=b.model,d=new Ammo.btCompoundShape,f,e;for(f=0;f<c.meshInstances.length;f++){var g=c.meshInstances[f],h=g.mesh,m=h.indexBuffer[pc.RENDERSTYLE_SOLID],
k=h.vertexBuffer,w=k.getFormat(),u=w.size/4,v;for(e=0;e<w.elements.length;e++){var B=w.elements[e];B.name===pc.SEMANTIC_POSITION&&(v=new Float32Array(k.lock(),B.offset))}var m=new Uint16Array(m.lock()),k=h.primitive[0].count/3,w=new Ammo.btVector3,B=new Ammo.btVector3,A=new Ammo.btVector3,C,z,F=h.primitive[0].base,I=new Ammo.btTriangleMesh;for(e=0;e<k;e++)h=m[F+3*e]*u,C=m[F+3*e+1]*u,z=m[F+3*e+2]*u,w.setValue(v[h],v[h+1],v[h+2]),B.setValue(v[C],v[C+1],v[C+2]),A.setValue(v[z],v[z+1],v[z+2]),I.addTriangle(w,
B,A,!0);e=new Ammo.btBvhTriangleMeshShape(I,!0);u=g.node.getWorldTransform().getScale();e.setLocalScaling(new Ammo.btVector3(u.x,u.y,u.z));u=g.node.getPosition();g=g.node.getRotation();m=new Ammo.btTransform;m.setIdentity();m.getOrigin().setValue(u.x,u.y,u.z);u=new Ammo.btQuaternion;u.setValue(g.x,g.y,g.z,g.w);m.setRotation(u);d.addChildShape(m,e)}c=a.getWorldTransform().getScale();f=new Ammo.btVector3;f.setValue(c.x,c.y,c.z);d.setLocalScaling(f);return d}},recreatePhysicalShapes:function(a){null!==
...
this._color.data[3]))}});Object.defineProperty(e.prototype,"materialAsset",{get:function(){return this._materialAsset},set:function(a){var b=this._system.app.assets,c=a;a instanceof pc.Asset&&(c=a.id);this._materialAsset!==c&&(this._materialAsset&&(a=b.get(this._materialAsset))&&(a.off("load",this._onMaterialLoad,this),a.off("change",this._onMaterialChange,this),a.off("remove",this._onMaterialRemove,this)),(this._materialAsset=c)?(c=b.get(this._materialAsset))?this._bindMaterialAsset(c):(this.material=
null,b.on("add:"+this._materialAsset,this._onMaterialAdded,this)):this.material=null)}});Object.defineProperty(e.prototype,"texture",{get:function(){return this._texture},set:function(a){(this._texture=a)?(this._meshInstance.setParameter("texture_emissiveMap",this._texture),this._meshInstance.setParameter("texture_opacityMap",this._texture),this._meshInstance.setParameter("material_emissive",this._color.data3),this._meshInstance.setParameter("material_opacity",this._color.data[3])):(this._meshInstance.deleteParameter("texture_emissiveMap"),
this._meshInstance.deleteParameter("texture_opacityMap"))}});Object.defineProperty(e.prototype,"textureAsset",{get:function(){return this._textureAsset},set:function(a){var b=this._system.app.assets,c=a;a instanceof pc.Asset&&(c=a.id);this._textureAsset!==c&&(this._textureAsset&&(a=b.get(this._textureAsset))&&(a.off("load",this._onTextureLoad,this),a.off("change",this._onTextureChange,this),a.off("remove",this._onTextureRemove,this)),(this._textureAsset=c)?(c=b.get(this._textureAsset))?this._bindTextureAsset(c):
(this.texture=null,b.on("add:"+this._textureAsset,this._onTextureAdded,this)):this.texture=null)}});Object.defineProperty(e.prototype,"spriteAsset",{get:function(){return this._spriteAsset},set:function(a){var b=this._system.app.assets,c=a;a instanceof pc.Asset&&(c=a.id);this._spriteAsset!==c&&(this._spriteAsset&&(a=b.get(this._spriteAsset))&&(a.off("load",this._onSpriteAssetLoad,this),a.off("change",this._onSpriteAssetChange,this),a.off("remove",this._onSpriteAssetRemove,this)),(this._spriteAsset=
c)?(c=b.get(this._spriteAsset))?this._bindSpriteAsset(c):(this.sprite=null,b.on("add:"+this._spriteAsset,this._onSpriteAssetAdded,this)):this.sprite=null)}});Object.defineProperty(e.prototype,"sprite",{get:function(){return this._sprite},set:function(a){this._sprite&&(this._sprite.off("set:meshes",this._onSpriteMeshesChange,this),this._sprite.off("set:pixelsPerUnit",this._onSpritePpuChange,this),this._sprite.off("set:atlas",this._onAtlasTextureChange,this),this._sprite.atlas&&this._sprite.atlas.off("set:texture",
this._onAtlasTextureChange,this));if(this._sprite=a)if(this._sprite.on("set:meshes",this._onSpriteMeshesChange,this),this._sprite.on("set:pixelsPerUnit",this._onSpritePpuChange,this),this._sprite.on("set:atlas",this._onAtlasTextureChange,this),this._sprite.atlas)this._sprite.atlas.on("set:texture",this._onAtlasTextureChange,this);this._meshInstance&&(this._sprite&&this._sprite.atlas&&this._sprite.atlas.texture?(this._meshInstance.setParameter("texture_emissiveMap",this._sprite.atlas.texture),this._meshInstance.setParameter("texture_opacityMap",
this._sprite.atlas.texture)):(this._meshInstance.deleteParameter("texture_emissiveMap"),this._meshInstance.deleteParameter("texture_opacityMap")));this.spriteFrame=this.spriteFrame}});Object.defineProperty(e.prototype,"spriteFrame",{get:function(){return this._spriteFrame},set:function(a){this._spriteFrame=this._sprite?pc.math.clamp(a,0,this._sprite.frameKeys.length-1):a;a=!1;var b=null;this._sprite&&this._sprite.atlas&&(b=this._sprite.meshes[this.spriteFrame],a=this._sprite.renderMode===pc.SPRITE_RENDERMODE_SLICED||
this._sprite.renderMode===pc.SPRITE_RENDERMODE_TILED);(this.mesh=a?b:this._defaultMesh)&&this._updateMesh(this.mesh)}});Object.defineProperty(e.prototype,"mesh",{get:function(){return this._mesh},set:function(a){this._mesh=a;this._meshInstance&&(this._meshInstance.mesh=this._mesh,this._meshInstance.visible=!!this._mesh,this._meshInstance._aabbVer=-1,this._meshInstance._updateAabbFunc=this._mesh===this._defaultMesh?null:this._updateAabbFunc)}});Object.defineProperty(e.prototype,"mask",{get:function(){return this._mask},
set:function(a){this._mask!==a&&(this._mask=a,this._toggleMask())}});Object.defineProperty(e.prototype,"pixelsPerUnit",{get:function(){return this._pixelsPerUnit},set:function(a){this._pixelsPerUnit!==a&&(this._pixelsPerUnit=a,!this._sprite||this._sprite.renderMode!==pc.SPRITE_RENDERMODE_SLICED&&this._sprite.renderMode!==pc.SPRITE_RENDERMODE_TILED||(this.spriteFrame=this.spriteFrame))}});return{ImageElement:e}}());pc.extend(pc,function(){var e=function(a){this._element=a;this._system=a.system;this._entity=a.entity;this._text="";this._font=this._fontAsset=null;this._color=new pc.Color(1,1,1,1);this._spacing=1;this._lineHeight=this._fontSize=32;this._wrapLines=!1;this._drawOrder=0;this._alignment=new pc.Vec2(.5,.5);this._autoHeight=this._autoWidth=!0;this.height=this.width=0;this._node=new pc.GraphNode;this._model=new pc.Model;this._model.graph=this._node;this._entity.addChild(this._node);this._meshInfo=[];this._material=
...
a},_updateMaterial:function(a){var b;a?(this._material=this._system.defaultScreenSpaceTextMaterial,b=!1):(this._material=this._system.defaultTextMaterial,b=!0);if(this._model)for(var c=0,d=this._model.meshInstances.length;c<d;c++){var e=this._model.meshInstances[c];e.cull=b;e.material=this._material;e.screenSpace=a}},_updateMeshes:function(d){function f(a,b){h._lineWidths.push(b);h._lineContents.push(d.substring(t,a));m=0;l-=h._lineHeight;r++;p=y=x=0;t=a}var e=this._font.data,h=this;this.height=this.width=
0;this._lineWidths=[];this._lineContents=[];var k=d.length,m=0,n=0,l=0,r=1,p=0,q=0,t=0,x=0,y=0,w=1E-4<=Math.abs(this._element.anchor.x-this._element.anchor.z),u=this._element.calculatedWidth;if(this.autoWidth&&!w||!this._wrapLines)u=Number.POSITIVE_INFINITY;var v=0,w=0,B=1,A,C,z,F;for(C in e.chars)z=e.chars[C],B=z.height/32*this._fontSize/z.height,z.bounds&&(v=Math.min(v,z.bounds[1]*B),w=Math.max(w,z.bounds[3]*B));for(F=0;F<this._meshInfo.length;F++)this._meshInfo[F].quad=0,this._meshInfo[F].lines=
{};for(F=0;F<k;F++){A=d.charAt(F);C=d.charCodeAt(F);var I=0,G=0,H=0,D=1,E=B=0;(z=e.chars[C])&&z.scale?(I=(z.width+z.height)/2,B=I/32*this._fontSize/I,D=I/32*this._fontSize/z.scale,H=z.xadvance*B,I=z.xoffset*B,G=z.yoffset*B,z.bounds?(E=(z.bounds[2]-z.bounds[0])*B,B*=z.bounds[0]):(E=I,B=0)):(H=1,G=I=0,D=this._fontSize);var J=a.test(A),Z=c.test(A),Y=b.test(A);if(J)f(F,n),q=F+1,t=F+1;else{A=this._meshInfo[z&&z.map||0];if(m+E+B>=u&&0<y&&!Y)if(0===x)q=F,f(F,n);else{z=Math.max(F-q,0);F-=z+1;A.lines[r-1]-=
z;A.quad-=z;f(q,p);continue}z=A.quad;A.lines[r-1]=z;A.positions[12*z+0]=m-I;A.positions[12*z+1]=l-G;A.positions[12*z+2]=0;A.positions[12*z+3]=m-I+D;A.positions[12*z+4]=l-G;A.positions[12*z+5]=0;A.positions[12*z+6]=m-I+D;A.positions[12*z+7]=l-G+D;A.positions[12*z+8]=0;A.positions[12*z+9]=m-I;A.positions[12*z+10]=l-G+D;A.positions[12*z+11]=0;this.width=Math.max(this.width,m+E+B);this.height=Math.max(this.height,w-(l+v));m+=this._spacing*H;Y||J||(n=m);Z&&(x++,p=n,q=F+1);y++;C=this._getUv(C);A.uvs[8*
z+0]=C[0];A.uvs[8*z+1]=C[1];A.uvs[8*z+2]=C[2];A.uvs[8*z+3]=C[1];A.uvs[8*z+4]=C[2];A.uvs[8*z+5]=C[3];A.uvs[8*z+6]=C[0];A.uvs[8*z+7]=C[3];A.quad++}}t<k&&f(k,m);this._noResize=!0;this.autoWidth=this._autoWidth;this.autoHeight=this._autoHeight;this._noResize=!1;e=this._element.pivot.data[0];k=this._element.pivot.data[1];n=this._alignment.x;q=this._alignment.y;for(F=0;F<this._meshInfo.length;F++)if(0!==this._meshInfo[F].count){z=0;for(var W in this._meshInfo[F].lines){u=this._meshInfo[F].lines[W];v=-e*
this._element.calculatedWidth+n*(this._element.calculatedWidth-this._lineWidths[parseInt(W,10)]);for(C=(1-k)*this._element.calculatedHeight-w-(1-q)*(this._element.calculatedHeight-this.height);z<=u;z++)this._meshInfo[F].positions[12*z]+=v,this._meshInfo[F].positions[12*z+3]+=v,this._meshInfo[F].positions[12*z+6]+=v,this._meshInfo[F].positions[12*z+9]+=v,this._meshInfo[F].positions[12*z+1]+=C,this._meshInfo[F].positions[12*z+4]+=C,this._meshInfo[F].positions[12*z+7]+=C,this._meshInfo[F].positions[12*
z+10]+=C;z=u+1}z=4*this._meshInfo[F].quad;u=new pc.VertexIterator(this._meshInfo[F].meshInstance.mesh.vertexBuffer);for(v=0;v<z;v++)u.element[pc.SEMANTIC_POSITION].set(this._meshInfo[F].positions[3*v+0],this._meshInfo[F].positions[3*v+1],this._meshInfo[F].positions[3*v+2]),u.element[pc.SEMANTIC_TEXCOORD0].set(this._meshInfo[F].uvs[2*v+0],this._meshInfo[F].uvs[2*v+1]),u.next();u.end();this._meshInfo[F].meshInstance.mesh.aabb.compute(this._meshInfo[F].positions);this._meshInfo[F].meshInstance._aabbVer=
...
a[1]);this._font&&this._updateText()}});Object.defineProperty(e.prototype,"autoWidth",{get:function(){return this._autoWidth},set:function(a){(this._autoWidth=a)&&1E-4>Math.abs(this._element.anchor.x-this._element.anchor.z)&&(this._element.width=this.width)}});Object.defineProperty(e.prototype,"autoHeight",{get:function(){return this._autoHeight},set:function(a){(this._autoHeight=a)&&1E-4>Math.abs(this._element.anchor.y-this._element.anchor.w)&&(this._element.height=this.height)}});return{TextElement:e}}());pc.extend(pc,{ORIENTATION_HORIZONTAL:0,ORIENTATION_VERTICAL:1,FITTING_NONE:0,FITTING_STRETCH:1,FITTING_SHRINK:2,FITTING_BOTH:3});pc.extend(pc,function(){function e(a){return a.element}function a(a){return a.enabled&&a.element&&a.element.enabled}function b(a){var b="_"+a;Object.defineProperty(c.prototype,a,{get:function(){return this[b]},set:function(a){this[b]!==a&&(this[b]=a,this._scheduleReflow())}})}var c=function(a,b){this._orientation=pc.ORIENTATION_HORIZONTAL;this._reverseX=!1;this._reverseY=!0;this._alignment=new pc.Vec2(0,1);this._padding=new pc.Vec4;this._spacing=new pc.Vec2;this._heightFitting=this._widthFitting=
...
c){c.onRemove()}});return{LayoutGroupComponentSystem:a}}());pc.extend(pc,function(){return{LayoutGroupComponentData:pc.inherits(function(){this.enabled=!0},pc.ComponentData)}}());pc.extend(pc,function(){function e(){}function a(a){function e(a,b,c){switch(a){case pc.FITTING_NONE:return f.NONE;case pc.FITTING_STRETCH:return b<c?f.APPLY_STRETCHING:f.NONE;case pc.FITTING_SHRINK:return b>=c?f.APPLY_SHRINKING:f.NONE;case pc.FITTING_BOTH:return b<c?f.APPLY_STRETCHING:b>=c?f.APPLY_SHRINKING:f.NONE;default:throw Error("Unrecognized fitting mode: "+a);}}function g(a,b){return t(a,b.size)+(a.length-1)*A.spacing[b.axis]}function h(a,b,c){var d=y(a,c.maxSize),f=x(a,c.fittingProportion),
e=v(f,d);b=B[c.axis]-b;for(var g=0;g<a.length;++g){var h=d[g],k=r(h,b,f,e),l=a[h][c.size]+k,m=Math.min(l,a[h][c.maxSize]);a[h][c.size]=m;b-=k-Math.max(l-m,0)}}function l(a,b,c){var d=y(a,c.minSize,!0),f;f=x(a,c.fittingProportion);if(1===f.length)f=[1];else{for(var e=[],g=f.length,h=0;h<g;++h)e.push((1-f[h])/(g-1));f=e}e=v(f,d);b-=B[c.axis];for(g=0;g<a.length;++g){var h=d[g],k=r(h,b,f,e),l=a[h][c.size]-k,m=Math.max(l,a[h][c.minSize]);a[h][c.size]=m;b-=k-Math.max(m-l,0)}}function r(a,b,c,d){c=c[a];
a=d[a];return 1E-5>Math.abs(c)&&1E-5>Math.abs(a)?b:b*c/a}function p(a){for(var b=[],c=0;c<a.length;++c){var d=a[c],f=Math.max(q(d,"minWidth"),0),e=Math.max(q(d,"minHeight"),0),g=Math.max(q(d,"maxWidth"),f),h=Math.max(q(d,"maxHeight"),e),k;k=q(d,"width");k=Math.min(Math.max(k,f),g);var l;l=q(d,"height");l=Math.min(Math.max(l,e),h);var m=q(d,"fitWidthProportion"),d=q(d,"fitHeightProportion");b.push({minWidth:f,minHeight:e,maxWidth:g,maxHeight:h,width:k,height:l,fitWidthProportion:m,fitHeightProportion:d})}return b}
function q(a,b){var c=a.entity.layoutchild;return c&&c.enabled&&void 0!==c[b]&&null!==c[b]?c[b]:void 0!==a[b]?a[b]:d[b]}function t(a,b){return a.reduce(function(a,c){return a+c[b]},0)}function x(a,b){var c=t(a,b),d=[],f=a.length,e;if(0===c)for(e=0;e<f;++e)d.push(1/f);else for(e=0;e<f;++e)d.push(a[e][b]/c);return d}function y(a,b,c){a.forEach(w);return a.slice().sort(function(a,d){return c?d[b]-a[b]:a[b]-d[b]}).map(u)}function w(a,b){a.index=b}function u(a){return a.index}function v(a,b){var c=[];
c[b[a.length-1]]=a[b[a.length-1]];for(var d=a.length-2;0<=d;--d)c[b[d]]=c[b[d+1]]+a[b[d]];return c}var B,A,C=b[a],z=b[c[a]];return function(a,b){A=b;B=new pc.Vec2(A.containerSize.x-A.padding.data[0]-A.padding.data[2],A.containerSize.y-A.padding.data[1]-A.padding.data[3]);for(var c=0;c<a.length;++c){var d=a[c],k=d.anchor.data;if(0!==k[0]||0!==k[1]||0!==k[2]||0!==k[3])d.anchor=[0,0,0,0]}if(A.wrap)for(var c=[[]],d=p(a),k=0,m=A[C.fitting]===pc.FITTING_SHRINK,n=0;n<a.length;++n){0<c[c.length-1].length&&
(k+=A.spacing[C.axis]);var q=d[n][C.size],k=k+q;!m&&k>B[C.axis]&&0!==c[c.length-1].length&&(k=q,c.push([]));c[c.length-1].push(a[n]);m&&k>B[C.axis]&&n!==a.length-1&&(k=0,c.push([]))}else c=[a];d=A.orientation===pc.ORIENTATION_HORIZONTAL&&A.reverseX||A.orientation===pc.ORIENTATION_VERTICAL&&A.reverseY;k=A.orientation===pc.ORIENTATION_HORIZONTAL&&A.reverseY||A.orientation===pc.ORIENTATION_VERTICAL&&A.reverseX;if(d)for(m=0;m<c.length;++m)d&&c[m].reverse();k&&c.reverse();d=[];for(k=0;k<c.length;++k)m=
p(c[k]),n=g(m,C),q=e(A[C.fitting],n,B[C.axis]),q===f.APPLY_STRETCHING?h(m,n,C):q===f.APPLY_SHRINKING&&l(m,n,C),d.push(m);for(var r=[],q=[],m=0;m<c.length;++m){n=c[m];n.largestElement=null;n.largestSize={width:Number.NEGATIVE_INFINITY,height:Number.NEGATIVE_INFINITY};for(k=0;k<n.length;++k){var t=d[m][k];t[z.size]>n.largestSize[z.size]&&(n.largestElement=n[k],n.largestSize=t)}r.push(n.largestElement);q.push(n.largestSize)}k=g(q,z);m=e(A[z.fitting],k,B[z.axis]);m===f.APPLY_STRETCHING?h(q,k,z):m===f.APPLY_SHRINKING&&
l(q,k,z);for(m=0;m<c.length;++m)for(n=c[m],k=0;k<n.length;++k)q=d[m][k],r=1===c.length?B[z.axis]:n.largestSize[z.size],t=e(A[z.fitting],q[z.size],r),t===f.APPLY_STRETCHING?q[z.size]=Math.min(r,q[z.maxSize]):t===f.APPLY_SHRINKING&&(q[z.size]=Math.max(r,q[z.minSize]));a:{k={};k[C.axis]=0;k[z.axis]=0;m=[];for(n=0;n<c.length;++n){q=c[n];if(0===q.length){k=void 0;break a}for(var r=[],t=d[n],u=0;u<q.length;++u){var x=q[u],w=t[u];k[z.axis]-=-w[z.size]*x.pivot[z.axis];k[C.axis]-=-w[C.size]*x.pivot[C.axis];
r[u]={};r[u][C.axis]=k[C.axis];r[u][z.axis]=k[z.axis];k[z.axis]+=-w[z.size]*x.pivot[z.axis];k[C.axis]+=w[C.size]*(1-x.pivot[C.axis])+A.spacing[C.axis]}q[C.size]=k[C.axis]-A.spacing[C.axis];q[z.size]=q.largestSize[z.size];k[C.axis]=0;k[z.axis]+=q[z.size]+A.spacing[z.axis];m.push(r)}c[z.size]=k[z.axis]-A.spacing[z.axis];k=m}m=k;n=A.alignment[C.axis];q=A.alignment[z.axis];r=A.padding[C.axis];t=A.padding[z.axis];for(u=0;u<c.length;++u)for(var x=c[u],w=d[u],v=m[u],y=(B[C.axis]-x[C.size])*n+r,F=(B[z.axis]-
c[z.size])*q+t,I=0;I<x.length;++I){var S=(x[z.size]-w[I][z.size])*A.alignment[z.axis];v[I][C.axis]+=y;v[I][z.axis]+=F+S}for(m=0;m<c.length;++m)for(n=c[m],q=d[m],r=k[m],t=0;t<n.length;++t)u=n[t],u[C.calculatedSize]=q[t][C.size],u[z.calculatedSize]=q[t][z.size],A.orientation===pc.ORIENTATION_HORIZONTAL?u.entity.setLocalPosition(r[t][C.axis],r[t][z.axis],u.entity.getLocalPosition().z):u.entity.setLocalPosition(r[t][z.axis],r[t][C.axis],u.entity.getLocalPosition().z)}}var b={};b[pc.ORIENTATION_HORIZONTAL]=
...
b.removeComponent(this)};e.prototype.getGuid=function(){return this._guid};e.prototype.setGuid=function(a){this._guid=a};e.prototype._notifyHierarchyStateChanged=function(a,b){var c=!1;a===this&&0===this._app._enableList.length&&(c=!0);a._beingEnabled=!0;a._onHierarchyStateChanged(b);a._onHierarchyStatePostChanged&&this._app._enableList.push(a);var d,f,e=a._children;d=0;for(f=e.length;d<f;d++)e[d]._enabled&&this._notifyHierarchyStateChanged(e[d],b);a._beingEnabled=!1;if(c){d=0;for(f=this._app._enableList.length;d<
f;d++)this._app._enableList[d]._onHierarchyStatePostChanged();this._app._enableList.length=0}};e.prototype._onHierarchyStateChanged=function(a){pc.Entity._super._onHierarchyStateChanged.call(this,a);var b,c=this.c,d;for(d in c)if(c.hasOwnProperty(d)&&(b=c[d],b.enabled))if(a)b.onEnable();else b.onDisable()};e.prototype._onHierarchyStatePostChanged=function(){var a=this.c,b;for(b in a)if(a.hasOwnProperty(b))a[b].onPostStateChange()};e.prototype.setRequest=function(a){this._request=a};e.prototype.getRequest=
...
e=!1,h=this;a._levelsEvents||(a._levelsEvents=[null,null,null,null,null,null]);a.data.textures.forEach(function(g,m){var k=function(a){a.ready(l);b.load(a)},l=function(g){f++;d[m]=g&&g.resource.getSource()||null;var k=a._levelsEvents[m];if(k!==g){k&&k.off("load",h._patchTexture,a);if(g)g.on("load",h._patchTexture,a);a._levelsEvents[m]=g||null}d[m]!==c._levels[0][m]&&(e=!0);6===f&&e&&(c.setSource(d),b.fire("load",a),b.fire("load:"+a.id,a),a.fire("load",a))},r=b.get(g);r?(r.ready(l),b.load(r)):g?(b.once("load:"+
...
m){var l;if("texture"===k.type){f._assetHandlers||(f._assetHandlers={});var q=f._assetHandlers[k.name];if(!k.data||k.data instanceof pc.Texture)q&&!k.data&&(h.off("load:"+q.id,q.bind),h.off("add:"+q.id,q.add),h.off("remove:"+q.id,q.remove),q.url&&(h.off("add:url:"+q.url,q.add),h.off("remove:url:"+q.url,q.remove)),f._assetHandlers[k.name]=null);else if(n?d=h.getByUrl(pc.path.join(g,k.data)):(l=k.data,d=h.get(k.data)),q&&(h.off("load:"+q.id,q.bind),h.off("add:"+q.id,q.add),h.off("remove:"+q.id,q.remove),
q.url&&(h.off("add:url:"+q.url,q.add),h.off("remove:url:"+q.url,q.remove)),f._assetHandlers[k.name]=null),q=f._assetHandlers[k.name]={id:l,url:n?pc.path.join(g,k.data):"",bind:function(a){e.parameters[m].data=a.resource;f[e.parameters[m].name]=a.resource;f.update()},add:function(a){h.load(a)},remove:function(a){f[e.parameters[m].name]===a.resource&&(e.parameters[m].data=null,f[e.parameters[m].name]=null,f.update())}},l?(h.on("load:"+l,q.bind),h.on("remove:"+l,q.remove)):n&&(h.on("load:url:"+pc.path.join(g,
k.data),q.bind),h.on("remove:url:"+pc.path.join(g,k.data),q.remove)),d)d.resource?q.bind(d):b[e.parameters[m].name]&&(l=a[b[e.parameters[m].name]])&&(e.parameters[m].data=l,f[e.parameters[m].name]=l),h.load(d);else if(l)h.once("add:"+l,q.add);else if(n)h.once("add:url:"+q.url,q.add)}else if("cubemap"===k.type&&k.data&&!(k.data instanceof pc.Texture)){n?d=h.getByUrl(pc.path.join(g,k.data)):(l=k.data,d=h.get(k.data));var q=function(a){e.shadingModel===pc.SPECULAR_PHONG&&(a.loadFaces=!0);a.ready(r);
h.load(a)},r=function(a){k.data=a.resource;1<a.resources.length&&(e.parameters.push({name:"prefilteredCubeMap128",data:a.resources[1]}),e.parameters.push({name:"prefilteredCubeMap64",data:a.resources[2]}),e.parameters.push({name:"prefilteredCubeMap32",data:a.resources[3]}),e.parameters.push({name:"prefilteredCubeMap16",data:a.resources[4]}),e.parameters.push({name:"prefilteredCubeMap8",data:a.resources[5]}),e.parameters.push({name:"prefilteredCubeMap4",data:a.resources[6]}));f.init(e);a.off("load",
c,f);a.on("load",c,f)};if(d)q(d);else if(l)h.once("add:"+l,q);else if(n)h.once("add:url:"+pc.path.join(g,k.data),function(a){a.ready(function(a){e.parameters[m].data=a.resource;f.init(e);a.off("load",c,f);a.on("load",c,f)});h.load(a)})}});f.init(e)}};return{MaterialHandler:d,getMaterialParamType:function(a){return e[a]}}}());pc.extend(pc,function(){var e=function(a){this._device=a;this._parsers=[];this.addParser(new pc.JsonModelParser(this._device),function(a,c){return".json"===pc.path.getExtension(a)})};e.DEFAULT_MATERIAL=pc.Scene.defaultMaterial;e.prototype={load:function(a,b){pc.http.get(a,function(c,d){b&&(c?b(pc.string.format("Error loading model: {0} [{1}]",a,c)):b(null,d))})},open:function(a,b){for(var c=0;c<this._parsers.length;c++){var d=this._parsers[c];if(d.decider(a,b))return d.parser.parse(b)}logWARNING(pc.string.format("No model parser found for: {0}",
...
c=new pc.Texture(this._device,{width:k.width,height:k.height,format:e});c.setSource(k)}else if(b instanceof ArrayBuffer){if(".crn"===d){c=b.byteLength;var k=new Uint8Array(b),d=Module._malloc(c),m=Module.HEAPU8,n,l=d/4,r=c%4,p=new Uint32Array(k.buffer,0,(c-r)/4),q=new Uint32Array(m.buffer);for(n=0;n<p.length;n++)q[l+n]=p[n];for(n=c-r;n<c;n++)m[d+n]=k[n];k=Module._crn_decompress_get_data(d,c);c=Module._crn_decompress_get_size(d,c);b=Module.HEAPU8.buffer.slice(k,k+c)}c=new Uint32Array(b,0,32);var d=
c[4],k=c[3],m=Math.max(c[7],1),t=c[21],x=c[22];n=65024===c[28];var y=q=p=r=l=!1;if(4===c[20])if(827611204===t)e=pc.PIXELFORMAT_DXT1,l=!0;else if(894720068===t)e=pc.PIXELFORMAT_DXT5,l=!0;else if(116===t)e=pc.PIXELFORMAT_RGBA32F,r=!0;else if(826496069===t)e=pc.PIXELFORMAT_ETC1,p=l=!0;else if(825438800===t||825504336===t)e=825438800===t?pc.PIXELFORMAT_PVRTC_2BPP_RGB_1:pc.PIXELFORMAT_PVRTC_2BPP_RGBA_1,q=l=!0;else{if(825439312===t||825504848===t)e=825439312===t?pc.PIXELFORMAT_PVRTC_4BPP_RGB_1:pc.PIXELFORMAT_PVRTC_4BPP_RGBA_1,
y=l=!0}else 32===x&&(e=pc.PIXELFORMAT_R8_G8_B8_A8);if(!e)return c=new pc.Texture(this._device,{width:4,height:4,format:pc.PIXELFORMAT_R8_G8_B8});c=new pc.Texture(this._device,{width:d,height:k,format:e,cubemap:n});n&&(c.addressU=pc.ADDRESS_CLAMP_TO_EDGE,c.addressV=pc.ADDRESS_CLAMP_TO_EDGE);for(var e=128,x=n?6:1,w,t=827611204===t?8:16,u,v=0;v<x;v++)for(var B=d,A=k,C=0;C<m;C++)l?p?w=Math.floor((B+3)/4)*Math.floor((A+3)/4)*8:q?w=Math.max(B,16)*Math.max(A,8)/4:y?w=Math.max(B,8)*Math.max(A,8)/2:(w=Math.floor((B+
4-1)/4),u=Math.floor((A+4-1)/4),w*=u,w*=t):w=B*A*4,u=r?new Float32Array(b,e,w):new Uint8Array(b,e,w),n?(c._levels[C]||(c._levels[C]=[]),c._levels[C][v]=u):c._levels[C]=u,e+=r?4*w:w,B=Math.max(.5*B,1),A=Math.max(.5*A,1);c.upload()}return c}},patch:function(b,d){var c=b.resource;if(c){c.name!==b.name&&(c.name=b.name);b.data.hasOwnProperty("minfilter")&&c.minFilter!==a[b.data.minfilter]&&(c.minFilter=a[b.data.minfilter]);b.data.hasOwnProperty("magfilter")&&c.magFilter!==a[b.data.magfilter]&&(c.magFilter=
...
pc.partitionSkin(c,null,k));for(k=0;k<c.skins.length;k++){var n=c.skins[k],l=[];for(m=0;m<n.inverseBindMatrices.length;m++){var r=n.inverseBindMatrices[m];l[m]=new pc.Mat4(r[0],r[1],r[2],r[3],r[4],r[5],r[6],r[7],r[8],r[9],r[10],r[11],r[12],r[13],r[14],r[15])}n=new pc.Skin(this._device,l,n.boneNames);d.push(n);l=new pc.SkinInstance(n);r=[];for(m=0;m<n.boneNames.length;m++){var p=b[0].findByName(n.boneNames[m]);r.push(p)}l.bones=r;e.push(l)}return{skins:d,instances:e}},_parseMorphs:function(a,b){var c=
a.model,d=[],e=[],k,m,n,l,r;if(c.morphs)for(k=0;k<c.morphs.length;k++){n=c.morphs[k].targets;r=[];for(m=0;m<n.length;m++){var p=n[m].aabb;l=p.min;p=p.max;l=new pc.BoundingBox(new pc.Vec3(.5*(p[0]+l[0]),.5*(p[1]+l[1]),.5*(p[2]+l[2])),new pc.Vec3(.5*(p[0]-l[0]),.5*(p[1]-l[1]),.5*(p[2]-l[2])));l=new pc.MorphTarget({indices:n[m].indices,deltaPositions:n[m].deltaPositions,deltaNormals:n[m].deltaNormals,name:n[m].name,aabb:l});r.push(l)}m=new pc.Morph(r);d.push(m);m=new pc.MorphInstance(m);e.push(m)}return{morphs:d,
instances:e}},_calculateTangentsMorphTarget:function(a,b,e,g,h,k,m,n){var c,d,f,q,t,x,y,w,u,v,B,A,C,z,F,I,G,H,D,E;I=g.length/3;for(E=0;E<I;E++)G=g[3*E],H=g[3*E+1],D=g[3*E+2],y=a[3*G],t=a[3*G+1],x=a[3*G+2],q=a[3*H],w=a[3*H+1],u=a[3*H+2],v=a[3*D],B=a[3*D+1],A=a[3*D+2],C=e[2*G],c=e[2*G+1],z=e[2*H],f=e[2*H+1],F=e[2*D],d=e[2*D+1],q-=y,y=v-y,w-=t,t=B-t,u-=x,x=A-x,z-=C,C=F-C,f-=c,A=d-c,c=z*A-C*f,0==c?(c=0,d=1,f=0,q=1,x=t=0):(F=1/c,c=(A*q-f*y)*F,d=(A*w-f*t)*F,f=(A*u-f*x)*F,q=(z*y-C*q)*F,t=(z*t-C*w)*F,x=(z*
x-C*u)*F),h[3*G+0]+=c,h[3*G+1]+=d,h[3*G+2]+=f,h[3*H+0]+=c,h[3*H+1]+=d,h[3*H+2]+=f,h[3*D+0]+=c,h[3*D+1]+=d,h[3*D+2]+=f,k[3*G+0]+=q,k[3*G+1]+=t,k[3*G+2]+=x,k[3*H+0]+=q,k[3*H+1]+=t,k[3*H+2]+=x,k[3*D+0]+=q,k[3*D+1]+=t,k[3*D+2]+=x;c=m.length;for(D=0;D<c;D++)E=m[D],u=b[3*E],d=b[3*E+1],w=b[3*E+2],a=h[3*E],e=h[3*E+1],g=h[3*E+2],I=k[3*E],G=k[3*E+1],H=k[3*E+2],x=u*a+d*e+w*g,y=u*x,t=d*x,x*=w,q=d*g-e*w,w=w*a-g*u,u=u*e-a*d,a-=y,e-=t,g-=x,x=1/Math.sqrt(a*a+e*e+g*g),a*=x,e*=x,g*=x,n[4*E]=a,n[4*E+1]=e,n[4*E+2]=g,
n[4*E+3]=0>q*I+w*G+u*H?-1:1;return n},_initMorphs:function(a,b,e,g){a=a.model;var c,d,f,n,l,r,p,q,t,x,y,w,u,v,B,A=[],C=[];for(e=0;e<g.length;e++)if(t=a.meshes[e].vertices,!C[t]&&(d=a.vertices[t],d.tangent)){var z=new Float32Array(d.tangent.data);C[t]=!0;if(d.position&&d.normal&&d.texCoord0){var F=[];for(c=0;c<a.meshes.length;c++)a.meshes[c].vertices===t&&(F=F.concat(a.meshes[c].indices));t=d.position.data;x=d.normal.data;y=d.texCoord0.data;w=t.length/3;u=F.length;var I=new Float32Array(4*w),G=new Float32Array(3*
w),H=new Float32Array(3*w);v=new Float32Array(3*w);v.set(t);B=new Float32Array(3*w);B.set(x);for(c=0;c<b.length;c++)if(a.meshes[e].morph===c)for(f=0;f<b[c]._targets.length;f++){d=b[c]._targets[f];var D=d.indices,E=D.length;if(0!==E){d.deltaTangents=new Float32Array(4*E);if(!q||q.length<w)q=new Uint8Array(w);else for(n=0;n<w;n++)q[n]=0;for(n=0;n<E;n++)l=D[n],q[l]=1;var J=0;for(n=0;n<u;n+=3)if(l=F[n],r=F[n+1],p=F[n+2],q[l]||q[r]||q[p])A[J]=l,A[J+1]=r,A[J+2]=p,J+=3;A.length=J;r=d.deltaPositions;p=d.deltaNormals;
for(n=0;n<E;n++)l=D[n],v[3*l]+=r[3*n],v[3*l+1]+=r[3*n+1],v[3*l+2]+=r[3*n+2],B[3*l]+=p[3*n],B[3*l+1]+=p[3*n+1],B[3*l+2]+=p[3*n+2];this._calculateTangentsMorphTarget(v,B,y,A,G,H,D,I);r=d.deltaTangents;for(n=0;n<E;n++)l=D[n],r[4*n]=I[4*n]-z[4*l],r[4*n+1]=I[4*n+1]-z[4*l+1],r[4*n+2]=I[4*n+2]-z[4*l+2],r[4*n+3]=I[4*n+3]-z[4*l+3];if(f!==b[c]._targets.length-1){for(n=0;n<u;n+=3)l=F[n],r=F[n+1],p=F[n+2],G[3*l+0]=0,G[3*l+1]=0,G[3*l+2]=0,G[3*r+0]=0,G[3*r+1]=0,G[3*r+2]=0,G[3*p+0]=0,G[3*p+1]=0,G[3*p+2]=0,H[3*l+
0]=0,H[3*l+1]=0,H[3*l+2]=0,H[3*r+0]=0,H[3*r+1]=0,H[3*r+2]=0,H[3*p+0]=0,H[3*p+1]=0,H[3*p+2]=0;for(n=0;n<E;n++)l=d.indices[n],v[3*l]=t[3*l],v[3*l+1]=t[3*l+1],v[3*l+2]=t[3*l+2],B[3*l]=x[3*l],B[3*l+1]=x[3*l+1],B[3*l+2]=x[3*l+2]}}}}}},_parseVertexBuffers:function(b){b=b.model;var c=[],e,g,h={position:pc.SEMANTIC_POSITION,normal:pc.SEMANTIC_NORMAL,tangent:pc.SEMANTIC_TANGENT,blendWeight:pc.SEMANTIC_BLENDWEIGHT,blendIndices:pc.SEMANTIC_BLENDINDICES,color:pc.SEMANTIC_COLOR,texCoord0:pc.SEMANTIC_TEXCOORD0,
...
g=b._area.z,h=b._area.uv));b=a.model.lightmapSizeMultiplier||1;e*=b;f*=b;g*=b;d.copy(a.localScale);for(a=a._parent;a;)d.mul(a.localScale),a=a._parent;d.x=Math.abs(d.x);d.y=Math.abs(d.y);d.z=Math.abs(d.z);e=e*d.y*d.z+f*d.x*d.z+g*d.x*d.y;e=Math.sqrt(e/h);return Math.min(pc.math.nextPowerOfTwo(e*c),this.scene.lightmapMaxResolution||2048)},bake:function(l,n){var p,q,r=this.device,x=this.scene,y=1;void 0===n&&(n=pc.BAKE_COLORDIR);n===pc.BAKE_COLORDIR&&(y=2);var w,u=[],v=[];if(l){var B;for(p=b.length-1;0<=
p;p--)for(q=0;q<l.length;q++)if(b[p]===l[q]){for(B=0;B<a[p].length;B++)a[p][B].destroy();a.splice(p,1);b.splice(p,1)}B=[];for(p=0;p<l.length;p++)e(l[p],B,v);l=B;e(this.root,null,null,u)}else{for(p=0;p<a.length;p++)for(q=0;q<a[p].length;q++)a[p][q].destroy();a=[];b=[];l=[];e(this.root,l,v,u)}if(0===l.length)r.fire("lightmapper:end",{timestamp:pc.now(),target:this});else{B=!1;x._needsStaticPrepare&&(x._needsStaticPrepare=!1,B=!0);var A=[],C=[[],[]],z={},F,I;q=new pc.Texture(this.device,{width:4,height:4,
format:pc.PIXELFORMAT_R8_G8_B8_A8,rgbm:!0});for(p=0;p<l.length;p++){F=this.calculateLightmapSize(l[p]);A.push(F);for(w=0;w<y;w++)I=new pc.Texture(r,{width:F,height:F,format:pc.PIXELFORMAT_R8_G8_B8_A8,mipmaps:!1,rgbm:0===w,minFilter:pc.FILTER_NEAREST,magFilter:pc.FILTER_NEAREST}),C[w].push(I);if(!z[F]){var G=new pc.Texture(r,{width:F,height:F,format:pc.PIXELFORMAT_R8_G8_B8_A8,mipmaps:!1,rgbm:!0,minFilter:pc.FILTER_NEAREST,magFilter:pc.FILTER_NEAREST}),G=new pc.RenderTarget(r,G,{depth:!1});z[F]=G}}var H=
x.layers;H._update();A=[];F=[];var G=[],D=[],E=H._lights;for(p=0;p<E.length;p++)E[p]._enabled&&(I=E[p]._mask,0!==(I&4)&&(F.push(I),G.push(E[p].shadowUpdateMode),E[p]._mask=4294967295,E[p].shadowUpdateMode=E[p]._type===pc.LIGHTTYPE_DIRECTIONAL?pc.SHADOWUPDATE_REALTIME:pc.SHADOWUPDATE_THISFRAME,A.push(E[p]),E[p].isStatic=!1)),D.push(E[p]._enabled),E[p].enabled=!1;var J=pc.shaderChunks,Z="#define UV1LAYOUT\n"+J.transformVS,Y=J.bakeLmEndPS;I=J.createShaderFromCode(r,J.fullscreenQuadVS,J.dilatePS,"lmDilate");
var W=r.scope.resolve("source"),Q=r.scope.resolve("pixelOffset"),O=r.scope.resolve("bakeDir"),T=new pc.Vec2,H=H._meshInstances;for(p=0;p<H.length;p++)H[p].node&&H[p].node.getWorldTransform();var H=x.fog,R=x.ambientLight.data[0],U=x.ambientLight.data[1],aa=x.ambientLight.data[2];x.fog=pc.FOG_NONE;x.ambientLight.data[0]=0;x.ambientLight.data[1]=0;x.ambientLight.data[2]=0;c||(c=new pc.Camera,c._node=new pc.GraphNode,c.clearColor[0]=0,c.clearColor[1]=0,c.clearColor[2]=0,c.clearColor[3]=0,c.clearDepth=
1,c.clearFlags=pc.CLEARFLAG_COLOR,c.clearStencil=null,c.frustumCulling=!1);var K,S,N,P,ba=[];ba.length=b.length;var M;for(K=0;K<u.length;K++){N=u[K].model.model.meshInstances;M=[];for(p=0;p<N.length;p++)M.push(N[p]._shaderDefs),N[p]._shaderDefs&=~(pc.SHADERDEF_LM|pc.SHADERDEF_DIRLM);for(p=0;p<b.length;p++)if(b[p]===u[K]){ba[p]=M;break}}M=[];var V=[],L;for(K=0;K<u.length;K++)if(M[K]=u[K].model.castShadows,u[K].model.castShadows=u[K].model.data.castShadowsLightmap,u[K].model.data.castShadowsLightmap)for(L=
u[K].model.meshInstances,p=0;p<L.length;p++)L[p].visibleThisFrame=!0,V.push(L[p]);this.renderer.updateCpuSkinMatrices(V);this.renderer.gpuUpdate(V);var fa=[],ga=[];L=[[],[]];var ca,da,ea,ka=[];ka.length=l.length;for(w=0;w<y;w++)m[w]||(p=new pc.StandardMaterial,p.chunks.transformVS=Z,0===w?(p.chunks.endPS=Y,p.ambient=new pc.Color(0,0,0),p.ambientTint=!0,p.lightMap=q):(p.chunks.basePS=J.basePS+"\nuniform sampler2D texture_dirLightMap;\nuniform float bakeDir;\n",p.chunks.endPS=J.bakeDirLmEndPS),p.chunks.outputAlphaPS=
"\n",p.chunks.outputAlphaOpaquePS="\n",p.chunks.outputAlphaPremulPS="\n",p.cull=pc.CULLFACE_NONE,p.forceUv1=!0,p.update(),p.updateShader(r,x),p.name="lmMaterial"+w,m[w]=p);for(K=0;K<l.length;K++){N=v[K];ka[K]=0;if(0<N.length)for(f.copy(N[0].aabb),p=0;p<N.length;p++)N[p].node.getWorldTransform(),f.add(N[p].aabb);p=new pc.BoundingBox;p.copy(f);ga.push(p);for(p=0;p<N.length;p++)P=N[p],P._shaderDefs&=~(pc.SHADERDEF_LM|pc.SHADERDEF_DIRLM),P.mask=4,P.deleteParameter("texture_lightMap"),P.deleteParameter("texture_dirLightMap"),
P.setParameter("texture_lightMap",P.material.lightMap?P.material.lightMap:q),P.setParameter("texture_dirLightMap",q);for(w=0;w<y;w++)S=C[w][K],ca=new pc.RenderTarget(r,S,{depth:!1}),L[w].push(ca)}for(q=0;q<A.length;q++)A[q].enabled=!1;J=[[],[],[]];Z=!1;for(p=0;p<A.length;p++){A[p].enabled=!0;Y=!1;A[p]._cacheShadowMap=!0;A[p]._type!==pc.LIGHTTYPE_DIRECTIONAL&&(A[p]._node.getWorldTransform(),A[p].getBoundingSphere(h),g.center=h.center,g.halfExtents.x=h.radius,g.halfExtents.y=h.radius,g.halfExtents.z=
h.radius);A[p]._type===pc.LIGHTTYPE_SPOT&&(q=A[p],ea=this.renderer.getShadowCamera(r,q),ea._node.setPosition(q._node.getPosition()),ea._node.setRotation(q._node.getRotation()),ea._node.rotateLocal(-90,0,0),ea.projection=pc.PROJECTION_PERSPECTIVE,ea.nearClip=q.attenuationEnd/1E3,ea.farClip=q.attenuationEnd,ea.aspectRatio=1,ea.fov=2*q._outerConeAngle,this.renderer.updateCameraFrustum(ea));0<v.length&&this.renderer.updateShaders(v[0]);for(K=0;K<l.length;K++){N=v[K];f=ga[K];if(A[p]._type===pc.LIGHTTYPE_DIRECTIONAL)d.copy(f.center),
d.y+=f.halfExtents.y,c._node.setPosition(d),c._node.setEulerAngles(-90,0,0),q=Math.max(f.halfExtents.x,f.halfExtents.z),c.projection=pc.PROJECTION_ORTHOGRAPHIC,c.nearClip=0,c.farClip=2*f.halfExtents.y,c.aspectRatio=1,c.orthoHeight=q;else if(!g.intersects(f))continue;if(A[p]._type===pc.LIGHTTYPE_SPOT){w=!1;for(q=0;q<N.length;q++)if(this.renderer._isVisible(ea,N[q])){w=!0;break}if(!w)continue}A[p]._type===pc.LIGHTTYPE_DIRECTIONAL?(J[pc.LIGHTTYPE_DIRECTIONAL][0]=A[p],J[pc.LIGHTTYPE_POINT].length=0,J[pc.LIGHTTYPE_SPOT].length=
0,!Y&&A[p].castShadows&&(this.renderer.cullDirectionalShadowmap(A[p],V,c,0),this.renderer.renderShadows(J[pc.LIGHTTYPE_DIRECTIONAL],0),Y=!0)):(J[pc.LIGHTTYPE_DIRECTIONAL].length=0,A[p]._type===pc.LIGHTTYPE_POINT?(J[pc.LIGHTTYPE_POINT][0]=A[p],J[pc.LIGHTTYPE_SPOT].length=0,!Y&&A[p].castShadows&&(this.renderer.cullLocalShadowmap(A[p],V),this.renderer.renderShadows(J[pc.LIGHTTYPE_POINT]),Y=!0)):(J[pc.LIGHTTYPE_POINT].length=0,J[pc.LIGHTTYPE_SPOT][0]=A[p],!Y&&A[p].castShadows&&(this.renderer.cullLocalShadowmap(A[p],
V),this.renderer.renderShadows(J[pc.LIGHTTYPE_SPOT]),Y=!0)));for(q=0;q<N.length;q++)fa[q]=N[q].material;for(w=0;w<y;w++){S=C[w][K];ca=L[w][K];P=z[S.width];da=P.colorBuffer;0===w?Z=x.updateShaders:Z&&(x.updateShaders=!0);for(q=0;q<N.length;q++)N[q].material=m[w];1<y&&this.renderer.updateShaders(N);this.renderer.setCamera(c,P,!0);1===w&&O.setValue(A[p].bakeDir?1:0);this.renderer._forwardTime=0;this.renderer._shadowMapTime=0;this.renderer.renderForward(c,N,N.length,J,pc.SHADER_FORWARDHDR);C[w][K]=da;
L[w][K]=P;z[S.width]=ca;for(q=0;q<N.length;q++)P=N[q],P.setParameter(k[w],da),P._shaderDefs|=pc.SHADERDEF_LM}ka[K]++;for(q=0;q<N.length;q++)N[q].material=fa[q]}A[p].enabled=!1;A[p]._cacheShadowMap=!1;A[p]._isCachedShadowMap&&A[p]._destroyShadowMap()}for(K=0;K<l.length;K++){N=v[K];ea=[];for(w=0;w<y;w++){S=C[w][K];ca=L[w][K];P=z[S.width];da=P.colorBuffer;T.set(1/S.width,1/S.height);Q.setValue(T.data);for(p=0;4>p;p++)W.setValue(S),pc.drawQuadWithShader(r,P,I),W.setValue(da),pc.drawQuadWithShader(r,ca,
I);for(p=0;p<N.length;p++)P=N[p],P.mask=2,N[p].setParameter(k[w],S),1===w&&(N[p]._shaderDefs|=pc.SHADERDEF_DIRLM);ea[w]=S;w===y-1&&ca.destroy()}a.push(ea);b.push(l[K])}for(var ha in z)z.hasOwnProperty(ha)&&(z[ha].colorBuffer.destroy(),z[ha].destroy());for(p=0;p<a.length;p++)for(q=0;q<a[p].length;q++)I=a[p][q],I.minFilter=pc.FILTER_LINEAR,I.magFilter=pc.FILTER_LINEAR;for(K=0;K<u.length;K++)u[K].model.castShadows=M[K];for(p=0;p<ba.length;p++)if(ba[p])for(N=b[p].model.model.meshInstances,q=0;q<N.length;q++)N[q]._shaderDefs|=
ba[p][q]&(pc.SHADERDEF_LM|pc.SHADERDEF_DIRLM);for(p=0;p<A.length;p++)A[p]._mask=F[p],A[p].shadowUpdateMode=G[p];for(p=0;p<E.length;p++)E[p].enabled=D[p];x.fog=H;x.ambientLight.data[0]=R;x.ambientLight.data[1]=U;x.ambientLight.data[2]=aa;B&&(x._needsStaticPrepare=!0)}}};return{Lightmapper:n}}());pc.extend(pc,function(){function e(a,b){if(a&&!b||!a&&b)return!1;a=a.data;b=b.data;if(a===b)return!0;if(a instanceof Float32Array&&b instanceof Float32Array){if(a.length!==b.length)return!1;for(var c=0;c<a.length;c++)if(a[c]!==b[c])return!1;return!0}return!1}var a=function(a,b,e){this.device=a;this.rootNode=e;this._dirty=!0;this.bones=b;b=b.length;a.supportsBoneTextures?(b=256<b?64:64<b?32:16<b?16:8,this.boneTexture=new pc.Texture(a,{width:b,height:b,format:pc.PIXELFORMAT_RGBA32F,mipmaps:!1,minFilter:pc.FILTER_NEAREST,
...
Number.POSITIVE_INFINITY);f*=.5;for(var c=this.device.supportsBoneTextures?1024:this.device.boneLimit,d,k,m,n,l,r,p,q,t,x=new pc.BoundingBox,y=new pc.BoundingBox,w=[],u=0,v=a,B,A;0<v.length;){w[u]=[];B=[];d=v[0].material;k=v[0].layer;t=v[0]._shaderDefs;n=v[0].parameters;q=v[0]._staticLightList;m=v[0].mesh.vertexBuffer.getNumVertices();x.copy(v[0].aabb);for(a=0;a<v.length;a++){if(0<a){if(d!==v[a].material){B.push(v[a]);continue}if(k!==v[a].layer){B.push(v[a]);continue}if(t!==v[a]._shaderDefs){B.push(v[a]);
continue}if(65535<m+v[a].mesh.vertexBuffer.getNumVertices()){B.push(v[a]);continue}y.copy(x);y.add(v[a].aabb);if(y.halfExtents.x>f||y.halfExtents.y>f||y.halfExtents.z>f){B.push(v[a]);continue}l=v[a].parameters;p=!1;for(r in n)if(n.hasOwnProperty(r)&&!e(n[r],l[r])){p=!0;break}if(!p)for(r in l)if(l.hasOwnProperty(r)&&!e(l[r],n[r])){p=!0;break}if(p){B.push(v[a]);continue}l=v[a]._staticLightList;if(q&&!l||!q&&l){B.push(v[a]);continue}if(q&&l){p=!1;for(A=0;A<q.length;A++)if(0>l.indexOf(q[A])){p=!0;break}for(A=
0;A<l.length;A++)if(0>q.indexOf(l[A])){p=!0;break}if(p){B.push(v[a]);continue}}}x.add(v[a].aabb);m+=v[a].mesh.vertexBuffer.getNumVertices();w[u].push(v[a]);if(b&&w[u].length===c){B=a===v.length?[]:v.slice(a+1);break}}u++;v=B}return w};b.prototype.create=function(b,d,e){this._init||(this.transformVS="#define BONE_LIMIT "+this.device.getBoneLimit()+"\n#define DYNAMICBATCH\n"+pc.shaderChunks.transformVS,this.skinTexVS=pc.shaderChunks.skinBatchTexVS,this.skinConstVS=pc.shaderChunks.skinBatchConstVS,this.vertexFormats=
{},this._init=!0);var c,f;e=new pc.Batch(b,d,e);this._batchList.push(e);var k=null,m,n,l,r,p,q,t,x,y,w=0,u=0;for(c=0;c<b.length;c++){if(!k)k=b[c].material;else if(k!==b[c].material)return;m=b[c].mesh;n=m.vertexBuffer.format.elements;l=m.vertexBuffer.numVertices;w+=l;for(f=0;f<n.length;f++)n[f].name===pc.SEMANTIC_POSITION?r=!0:n[f].name===pc.SEMANTIC_NORMAL?p=!0:n[f].name===pc.SEMANTIC_TEXCOORD0?q=!0:n[f].name===pc.SEMANTIC_TEXCOORD1?t=!0:n[f].name===pc.SEMANTIC_TANGENT?x=!0:n[f].name===pc.SEMANTIC_COLOR&&
(y=!0);u+=m.primitive[0].count}if(r){var v=3+(p?3:0)+(q?2:0)+(t?2:0)+(x?4:0)+(y?1:0)+(d?1:0),B=p?6:3,A=(p?6:3)+(q?2:0),C=(p?6:3)+(q?2:0)+(t?2:0),z=(p?6:3)+(q?2:0)+(t?2:0)+(x?4:0),F=(p?6:3)+(q?2:0)+(t?2:0)+(x?4:0)+(y?1:0),I=new ArrayBuffer(w*v*4);r=new Float32Array(I);var G=new Uint8Array(I),I=new pc.IndexBuffer(this.device,pc.INDEXFORMAT_UINT16,u,pc.BUFFER_STATIC),H=new Uint16Array(I.lock()),D,E,J,Z=0,Y=0;J=0;var W,Q,O,T,R,U,aa,K,S;d||(K=new pc.Vec3,S=K.data);for(c=0;c<b.length;c++){m=b[c].mesh;n=
m.vertexBuffer.format.elements;l=m.vertexBuffer.numVertices;f=m.vertexBuffer.format.size;D=f/4;for(f=0;f<n.length;f++)n[f].name===pc.SEMANTIC_POSITION?W=n[f].offset/4:n[f].name===pc.SEMANTIC_NORMAL?Q=n[f].offset/4:n[f].name===pc.SEMANTIC_TEXCOORD0?O=n[f].offset/4:n[f].name===pc.SEMANTIC_TEXCOORD1?T=n[f].offset/4:n[f].name===pc.SEMANTIC_TANGENT?R=n[f].offset/4:n[f].name===pc.SEMANTIC_COLOR&&(U=n[f].offset/4);n=new Float32Array(m.vertexBuffer.storage);E=new Uint8Array(m.vertexBuffer.storage);if(d)for(f=
0;f<l;f++)r[f*v+J]=n[f*D+W],r[f*v+J+1]=n[f*D+W+1],r[f*v+J+2]=n[f*D+W+2],p&&(r[f*v+J+3]=n[f*D+Q],r[f*v+J+3+1]=n[f*D+Q+1],r[f*v+J+3+2]=n[f*D+Q+2]),q&&(r[f*v+J+B]=n[f*D+O],r[f*v+J+B+1]=n[f*D+O+1]),t&&(r[f*v+J+A]=n[f*D+T],r[f*v+J+A+1]=n[f*D+T+1]),x&&(r[f*v+J+C]=n[f*D+R],r[f*v+J+C+1]=n[f*D+R+1],r[f*v+J+C+2]=n[f*D+R+2],r[f*v+J+C+3]=n[f*D+R+3]),y&&(G[f*v*4+4*J+4*z]=E[f*D*4+4*U],G[f*v*4+4*J+4*z+1]=E[f*D*4+4*U+1],G[f*v*4+4*J+4*z+2]=E[f*D*4+4*U+2],G[f*v*4+4*J+4*z+3]=E[f*D*4+4*U+3]),r[f*v+F+J]=c;else for(aa=
b[c].node.getWorldTransform(),f=0;f<l;f++)K.set(n[f*D+W],n[f*D+W+1],n[f*D+W+2]),aa.transformPoint(K,K),r[f*v+J]=S[0],r[f*v+J+1]=S[1],r[f*v+J+2]=S[2],p&&(K.set(n[f*D+Q],n[f*D+Q+1],n[f*D+Q+2]),aa.transformVector(K,K),r[f*v+J+3]=S[0],r[f*v+J+3+1]=S[1],r[f*v+J+3+2]=S[2]),q&&(r[f*v+J+B]=n[f*D+O],r[f*v+J+B+1]=n[f*D+O+1]),t&&(r[f*v+J+A]=n[f*D+T],r[f*v+J+A+1]=n[f*D+T+1]),x&&(K.set(n[f*D+R],n[f*D+R+1],n[f*D+R+2]),aa.transformVector(K,K),r[f*v+J+C]=S[0],r[f*v+J+C+1]=S[1],r[f*v+J+C+2]=S[2],r[f*v+J+C+3]=n[f*
D+R+3]),y&&(G[f*v*4+4*J+4*z]=E[f*D*4+4*U],G[f*v*4+4*J+4*z+1]=E[f*D*4+4*U+1],G[f*v*4+4*J+4*z+2]=E[f*D*4+4*U+2],G[f*v*4+4*J+4*z+3]=E[f*D*4+4*U+3]);J=m.primitive[0].base;D=m.primitive[0].count;m=new Uint16Array(m.indexBuffer[0].storage);for(f=0;f<D;f++)H[f+Y]=m[J+f]+Z;Y+=D;Z+=l;J=Z*v}b=0;p&&(b|=2);q&&(b|=4);t&&(b|=8);x&&(b|=16);y&&(b|=32);d&&(b|=64);c=this.vertexFormats[b];c||(c=[],c.push({semantic:pc.SEMANTIC_POSITION,components:3,type:pc.ELEMENTTYPE_FLOAT32,normalize:!1}),p&&c.push({semantic:pc.SEMANTIC_NORMAL,
...
normalize:!1}),c=this.vertexFormats[b]=new pc.VertexFormat(this.device,c));p=new pc.VertexBuffer(this.device,c,w,pc.BUFFER_STATIC,r.buffer);I.unlock();m=new pc.Mesh;m.vertexBuffer=p;m.indexBuffer[0]=I;m.primitive[0].type=e.origMeshInstances[0].mesh.primitive[0].type;m.primitive[0].base=0;m.primitive[0].count=u;m.primitive[0].indexed=!0;m.cull=!1;d&&(k=k.clone(),k.chunks.transformVS=this.transformVS,k.chunks.skinTexVS=this.skinTexVS,k.chunks.skinConstVS=this.skinConstVS,k.update());k=new pc.MeshInstance(this.rootNode,
m,k);k.castShadow=e.origMeshInstances[0].castShadow;k.parameters=e.origMeshInstances[0].parameters;k.isStatic=e.origMeshInstances[0].isStatic;k.cull=e.origMeshInstances[0].cull;k.layer=e.origMeshInstances[0].layer;k._staticLightList=e.origMeshInstances[0]._staticLightList;k._shaderDefs=e.origMeshInstances[0]._shaderDefs;if(d){d=[];for(c=0;c<e.origMeshInstances.length;c++)d.push(e.origMeshInstances[c].node);k.skinInstance=new a(this.device,d,this.rootNode)}k._updateAabb=!1;e.meshInstance=k;this.update(e);
